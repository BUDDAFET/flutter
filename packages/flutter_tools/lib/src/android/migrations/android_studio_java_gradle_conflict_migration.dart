...
class AndroidStudioJavaGradleConflictMigration extends ProjectMigrator {
  AndroidStudioJavaGradleConflictMigration(
    ...
    required Java? java,
            ...
            getGradleWrapperFile(project.hostAppGradleRoot),
  ...
  String migrateFileContents(String fileContents) {
    ...
    final RegExpMatch? gradleDistributionUrl =
        gradleOrgVersionMatch.firstMatch(fileContents);
    ...
    if (gradleVersionsToUpgradeFrom.contains(existingVersionString)) {
      ...
      final String? gradleDistributionUrlString =
          gradleDistributionUrl.group(0);
      if (gradleDistributionUrlString != null) {
        final String upgradedDistributionUrl = gradleDistributionUrlString
            .replaceAll(existingVersionString, gradleVersion7_6_1);
        fileContents = fileContents.replaceFirst(
            gradleOrgVersionMatch, upgradedDistributionUrl);
      } else {
        logger.printTrace(gradleVersionNotFound);
      }
    }
