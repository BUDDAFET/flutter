...
class MacOSDeploymentTargetMigration extends ProjectMigrator {
  ...
  String? migrateLine(String line) {
    ...
    const String deploymentTargetOriginal1011 =
        'MACOSX_DEPLOYMENT_TARGET = 10.11;';
    const String deploymentTargetOriginal1013 =
    ...
    if (line.contains(deploymentTargetOriginal1011) ||
      ...
      if (!migrationRequired) {
        ...
        logger
            .printStatus('Updating minimum macOS deployment target to 10.14.');
      }
      ...
      return line
          ...
          .replaceAll(podfilePlatformVersionOriginal1011,
              podfilePlatformVersionReplacement)
          .replaceAll(podfilePlatformVersionOriginal1013,
              podfilePlatformVersionReplacement);
    }
