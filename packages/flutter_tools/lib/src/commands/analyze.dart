  ...
  Future<FlutterCommandResult> runCommand() async {
    if (boolArg('android')) {
      ...
      if (argResults!['list-build-variants'] as bool) {
        ...
        throwToolExit(
            'No argument is provided to analyze. Use -h to see available commands.');
      }
      ...
      if (items.isEmpty) {
        ...
        throwToolExit(
            'The Android analyze can process only one directory path');
      } else {
      ...
      await IOSAnalyze(
        project:
            FlutterProject.fromDirectory(_fileSystem.directory(directoryPath)),
        option: option,
