...
class GenerateLocalizationsCommand extends FlutterCommand {
  GenerateLocalizationsCommand({
    ...
    argParser.addOption('header-file',
        help: 'The header to prepend to the generated Dart localizations '
    ...
    argParser.addOption('gen-inputs-and-outputs-list',
    ...
    argParser.addFlag('required-resource-attributes',
        help:
    ...
    argParser.addFlag('nullable-getter',
        defaultsTo: true,
    ...
    argParser.addFlag('suppress-warnings',
        help: 'When specified, all warnings will be suppressed.\n');
    argParser.addFlag(
      'relax-syntax',
      help:
          'When specified, the syntax will be relaxed so that the special character '
  ...
  Future<FlutterCommandResult> runCommand() async {
    ...
    if (_fileSystem.file('l10n.yaml').existsSync()) {
      ...
      options = parseLocalizationsOptionsFromCommand(
          command: this, defaultArbDir: defaultArbDir);
    }
