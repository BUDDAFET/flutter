...
class BlockHashes {
  ...
  BlockHashes.fromJson(Map<String, Object?> obj)
      : blockSize = obj['blockSize']! as int,
        ...
        adler32 =
            Uint32List.view(base64.decode(obj['adler32']! as String).buffer),
...
class FileTransfer {
  ...
  Future<BlockHashes> calculateBlockHashesOfFile(File file,
    ...
    await convertToChunks(fileContentStream, blockSize)
  ...
  Future<String> _md5OfFile(File file) async {
    ...
    await file.openRead().forEach((List<int> chunk) => fileMd5Hash
        .addChunk(chunk is Uint8List ? chunk : Uint8List.fromList(chunk)));
