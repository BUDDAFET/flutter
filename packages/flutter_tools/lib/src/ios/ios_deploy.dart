...
class IOSDeployDebugger {
  ...
  Future<void> stdinWriteln(String line,
      {required void Function(Object, StackTrace) onError}) async {
    ...
    _stdinWriteFuture =
        _stdinWriteFuture?.then<void>((_) => writeln()) ?? writeln();
  ...
  Future<void> detach() async {
    ...
    return stdinWriteln('process detach', onError: (Object error, _) {
