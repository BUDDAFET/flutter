...
class RemoveFrameworkLinkAndEmbeddingMigration extends ProjectMigrator {
  ...
  String? migrateLine(String line) {
    ...
    if (line.contains('3B80C3951E831B6300D905FE') ||
        line.contains('741F496821356857001E2961')) {
    ...
    if (line.contains('3B80C3931E831B6300D905FE') ||
        line.contains('741F496521356807001E2961')) {
      // Ephemeral add-to-app variant.
      return null;
    }
    ...
    if (line.contains('9705A1C71CF904A300538489') ||
        line.contains('741F496221355F47001E2961')) {
      // Ephemeral add-to-app variant.
      return null;
    }
    ...
    if (line.contains('9740EEBA1CF902C7004384FC') ||
        line.contains('741F495E21355F27001E2961')) {
      // Ephemeral add-to-app variant.
      return null;
    }
    ...
    if (line.contains(thinBinaryScript) && !line.contains(' embed')) {
      return line.replaceFirst(
          thinBinaryScript, r'xcode_backend.sh\" embed_and_thin');
    }

    if (line.contains('/* App.framework ') ||
        line.contains('/* Flutter.framework ')) {
      // Print scary message.
      UsageEvent('ios-migration', 'remove-frameworks',
