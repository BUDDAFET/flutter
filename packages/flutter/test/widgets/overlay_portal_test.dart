...
void rebuildLayoutBuilderSubtree(RenderBox descendant, WidgetTester tester) {
  assert(
      descendant is! RenderConstrainedLayoutBuilder<BoxConstraints, RenderBox>);
  ...
  while (node != null) {
    if (node is! RenderConstrainedLayoutBuilder<BoxConstraints, RenderBox>) {
      ...
      final Element layoutBuilderElement =
          tester.element(find.byElementPredicate(
        (Element element) =>
            element.widget is LayoutBuilder && element.renderObject == node,
      ));
...
void verifyOverlayChildReadyForLayout(GlobalKey overlayWidgetKey) {
  final RenderBox layoutSurrogate =
  ...
  expect(
      !layoutSurrogate.debugNeedsLayout || layoutSurrogate.debugDoingThisLayout,
      true);
}
...
void main() {
  final OverlayPortalController controller1 =
      OverlayPortalController(debugLabel: 'controller1');
  final OverlayPortalController controller2 =
      OverlayPortalController(debugLabel: 'controller2');
  final OverlayPortalController controller3 =
      OverlayPortalController(debugLabel: 'controller3');
  final OverlayPortalController controller4 =
      OverlayPortalController(debugLabel: 'controller4');
  ...
  testWidgets('The overlay child sees the right inherited widgets',
  ...
  testWidgets('Safe to deactivate and re-activate OverlayPortal',
      (WidgetTester tester) async {
    late final OverlayEntry overlayEntry;
    addTearDown(() => overlayEntry
      ..remove()
  ...
  testWidgets(
      'Safe to hide overlay child and remove OverlayPortal in the same frame',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Safe to hide overlay child and reparent OverlayPortal in the same frame',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Safe to hide overlay child and reparent OverlayPortal in the same frame 2',
      (WidgetTester tester) async {
    late final OverlayEntry overlayEntry;
    addTearDown(() => overlayEntry
      ..remove()
  ...
  testWidgets(
    ...
    expect(
      ...
      stringContainsInOrder(
          <String>['Failed to attach', 'It is already attached to']),
    );
  });
  ...
  testWidgets('throws when no Overlay', (WidgetTester tester) async {
    ...
    expect(
      tester.takeException().toString(),
      startsWith('No Overlay widget found.\n'
  ...
  testWidgets('widget is laid out before overlay child',
      (WidgetTester tester) async {
    ...
    final RenderBox overlayChildBox =
        RenderConstrainedBox(additionalConstraints: const BoxConstraints());
    late final OverlayEntry overlayEntry;
    addTearDown(() => overlayEntry
      ..remove()
    ...
    final RenderObject renderChild1 =
    ...
    // boundary).
    expect(widgetKey.currentContext!.findRenderObject()!.depth,
  ...
  testWidgets(
    ...
    addTearDown(() => overlayEntry1
      ..remove()
      ..dispose());
    late final OverlayEntry overlayEntry2;
    addTearDown(() => overlayEntry2
      ..remove()
      ..dispose());
    int layoutCount = 0;
    controller1.hide();
                    ...
                    return OverlayPortal(
                      ...
                      overlayChildBuilder: (BuildContext context) {
                        return LayoutBuilder(builder:
                          ...
                          expect(
                              tester
                                  .renderObject(find.byType(Overlay))
                                  .debugNeedsLayout,
                              false);
                          return WidgetToRenderBoxAdapter(
                              renderBox: overlayChildBox);
  ...
  group('Adding/removing overlay child causes repaint', () {
    ...
    testWidgets('Adding child', (WidgetTester tester) async {
      ...
      final RenderBox renderTheater =
          tester.renderObject<RenderBox>(find.byType(Overlay));
      final RenderBox renderChild =
                      ...
                      child: _ManyRelayoutBoundaries(
                        ...
                        child: Builder(builder: (BuildContext context) {
                          return OverlayPortal(
                            ...
                            child:
                                WidgetToRenderBoxAdapter(renderBox: childBox),
                          );
                        }),
                      ),
                    );
  ...
  testWidgets('Can target the root overlay', (WidgetTester tester) async {
                          ...
                          initialEntries: <OverlayEntry>[
                            ...
                            _buildOverlayEntry((BuildContext context) =>
                                WidgetToRenderBoxAdapter(
                                    renderBox: overlayLayoutCounter)),
                            _buildOverlayEntry(
                                (BuildContext outerEntryContext) {
                              return Center(
                                child: Builder(builder: (BuildContext context) {
    ...
    expect(layoutCount, 2);
    expect(overlayLayoutCounter.layoutCount, 1);
    expect(_ancestorRenderTheaters(overlayChildBox).single,
  ...
  group('GlobalKey Reparenting', () {
    testWidgets(
      ...
      final RenderBox overlayChildBox =
          RenderConstrainedBox(additionalConstraints: const BoxConstraints());
      final OverlayEntry overlayEntry1 =
      ...
      addTearDown(() => overlayEntry1
        ..remove()
        ..dispose());
      final OverlayEntry overlayEntry2 =
          OverlayEntry(builder: (BuildContext context) => const Placeholder());
      addTearDown(() => overlayEntry2
        ..remove()
        ..dispose());
      final OverlayEntry overlayEntry3 =
          OverlayEntry(builder: (BuildContext context) => const Placeholder());
      addTearDown(() => overlayEntry3
        ..remove()
        ..dispose());
      ...
      tester.state<OverlayState>(find.byType(Overlay)).rearrange(
          <OverlayEntry>[overlayEntry3, overlayEntry2, overlayEntry1]);
      await tester.pump();
      expect(layoutCount, 2);
      expect(widgetKey.currentContext!.findRenderObject()!.depth,
          lessThan(overlayChildBox.depth));
    ...
    testWidgets('Swap child and overlayChild', (WidgetTester tester) async {
      ...
      final Widget child1 =
          WidgetToRenderBoxAdapter(renderBox: overlayChildBox);
    ...
    testWidgets('Nested overlay children: swap inner and outer',
        (WidgetTester tester) async {
      ...
      final RenderBox child1Box =
          RenderConstrainedBox(additionalConstraints: const BoxConstraints());
      final RenderBox child2Box =
          RenderConstrainedBox(additionalConstraints: const BoxConstraints());
      final RenderBox overlayChildBox =
          RenderConstrainedBox(additionalConstraints: const BoxConstraints());
    ...
    group('Swapping', () {
      ...
      testWidgets('between OverlayEntry & overlayChild',
          (WidgetTester tester) async {
      ...
      testWidgets('between overlayChild & overlayChild',
          (WidgetTester tester) async {
        final _RenderLayoutCounter counter1 = _RenderLayoutCounter();
        final _RenderLayoutCounter counter2 = _RenderLayoutCounter();
    ...
    testWidgets(
      ...
      final GlobalKey overlayChildKey =
          GlobalKey(debugLabel: 'overlay child key');
  ...
  group('Paint order', () {
    ...
    testWidgets('Paint order does not change after global key reparenting',
      ...
      final RenderObject theater =
          tester.renderObject<RenderObject>(find.byType(Overlay));
      ...
      expect(
          childrenVisited,
          containsAllInOrder(
              <RenderObject>[child1Box.parent, child2Box.parent]));
  ...
  group('Semantics', () {
                    ...
                    children: <Widget>[
                      Semantics(
                        ...
                        child: OverlayPortal(
                          ...
                          overlayChildBuilder: (BuildContext context) =>
                              const Positioned(
                                  left: 0.0, top: 0.0, child: Text('BBBB')),
                          child: const Text('A'),
                        ),
                      ),
                      const Text('CC'),
      ...
      final TestSemantics expected =
        ...
        TestSemantics(
          ...
          children: <TestSemantics>[
            TestSemantics(
                id: 2, label: 'A', rect: Offset.zero & const Size(10, 10)),
    ...
    testWidgets('OverlayPortal overlay child clipping',
        (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
                            ...
                            return Positioned(
                              ...
                              child: ListView(
                                children: const <Widget>[
                                  SizedBox(
                                      height:
                                          3), // Clips B so it's only 7 pixels tall.
                                  Text('B'),
                                ],
                              ),
                            );
      ...
      final SemanticsNode clippedOverlayPortal =
          semantics.nodesWith(label: 'A').single;
      final SemanticsNode clippedOverlayChild =
          semantics.nodesWith(label: 'B').single;
      ...
      expect(clippedOverlayChild.transform,
          Matrix4.translationValues(0.0, 3.0, 0.0));

      semantics.dispose();
    });

    testWidgets("OverlayPortal's semantics node is hidden",
        (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      ...
      expect(clippedOverlayChild.transform,
          Matrix4.translationValues(0.0, -600.0, 0.0));

      semantics.dispose();
    });

    testWidgets(
        "OverlayPortal's semantics node is dropped but the element is kept alive",
        (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
...
OverlayEntry _buildOverlayEntry(WidgetBuilder builder) =>
...
class _PaintOrder extends SingleChildRenderObjectWidget {
  ...
  void updateRenderObject(
          BuildContext context, _RenderPaintRecorder renderObject) =>
