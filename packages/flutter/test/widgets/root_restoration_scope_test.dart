...
void main() {
  ...
  testWidgets('does not inject root bucket if inside scope',
  ...
  testWidgets('no delay when root is available synchronously',
      (WidgetTester tester) async {
    final Map<String, dynamic> rawData = <String, dynamic>{};
    final RestorationBucket root = RestorationBucket.root(
        manager: binding.restorationManager, rawData: rawData);
  ...
  testWidgets('does not insert root when restoration id is null',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('injects root bucket when moved out of scope',
      (WidgetTester tester) async {
  ...
  testWidgets('injects new root when old one is decommissioned',
      (WidgetTester tester) async {
  ...
  testWidgets('injects null when rootBucket is null',
      (WidgetTester tester) async {
