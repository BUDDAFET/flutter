...
void main() {
  ...
  testWidgets('Router respects update order',
    ...
    await tester.pumpWidget(buildBoilerPlate(IntInheritedNotifier(
      notifier: notifier,
...
class MutableRouterDelegate extends RouterDelegate<RouteInformation>
    with ChangeNotifier {
...
class IntInheritedNotifier extends InheritedNotifier<ValueListenable<int>> {
  const IntInheritedNotifier(
      {super.key, required super.notifier, required super.child});

  static int of(BuildContext context) {
    return context
        .dependOnInheritedWidgetOfExactType<IntInheritedNotifier>()!
        .notifier!
        .value;
  }
}
