...
void main() {
  ...
  testWidgets('No initial animation when begin=null',
  ...
  testWidgets('No initial animation when begin=end',
      (WidgetTester tester) async {
    final List<int> values = <int>[];
    int endCount = 0;
    await tester.pumpWidget(
  ...
  testWidgets('Curve is respected', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(buildWidget(
        tween: IntTween(begin: 0, end: 100), curve: Curves.easeInExpo));
    expect(values, <int>[0]);
    await tester.pump(const Duration(milliseconds: 500));
    ...
    await tester.pumpWidget(buildWidget(
        tween: IntTween(begin: 100, end: 200), curve: Curves.linear));
    expect(values, <int>[100]);
    await tester.pump(const Duration(milliseconds: 500));
  ...
  group('Change tween gapless while', () {
    testWidgets('running forward', (WidgetTester tester) async {
      ...
      expect(values,
          <int>[0, 50, 50]); // gapless: animation continues where it left off.
      ...
      expect(values, <int>[
        ...
        50,
        175
      ]); // 175 = halfway between 50 and new target 300.
