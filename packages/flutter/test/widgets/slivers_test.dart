...
void main() {
  ...
  testWidgets('Sliver grid can replace intermediate items',
                ...
                slivers: <Widget>[
                  SliverGrid(
                    ...
                    delegate: SliverChildBuilderDelegate(
                      (BuildContext context, int index) {
                        final int item =
                            replace ? replacedItems[index] : items[index];
                        return Container(
  ...
  testWidgets('SliverFixedExtentList correctly clears garbage',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    List<Widget> children = <Widget>[
      for (final String item in items)
        StateInitSpy(item, () => initializedChild.add(item),
  ...
  group('SliverIgnorePointer - ', () {
    ...
    testWidgets('ignoring only block semantics actions',
        (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      await tester.pumpWidget(boilerPlate(
        SliverIgnorePointer(
    ...
    testWidgets('ignores pointer events & semantics',
        (WidgetTester tester) async {
      final SemanticsTester semantics = SemanticsTester(tester);
      final List<String> events = <String>[];
      await tester.pumpWidget(boilerPlate(
  ...
  testWidgets('SliverList handles 0 scrollOffsetCorrection',
      (WidgetTester tester) async {
  ...
  testWidgets('SliverGrid children can be arbitrarily placed',
      (WidgetTester tester) async {
  ...
  testWidgets('SliverList.builder can build children',
      (WidgetTester tester) async {
    int firstTapped = 0;
    int secondTapped = 0;
    final Key key = UniqueKey();
  ...
  testWidgets('SliverList.separated can build children',
      (WidgetTester tester) async {
    int firstTapped = 0;
    int secondTapped = 0;
    final Key key = UniqueKey();
  ...
  testWidgets('SliverList.separated has correct number of children',
      (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(MaterialApp(
      home: Scaffold(
  ...
  testWidgets('SliverList.list can build children',
      (WidgetTester tester) async {
    int firstTapped = 0;
    int secondTapped = 0;
    final Key key = UniqueKey();
  ...
  testWidgets('SliverFixedExtentList.builder can build children',
      (WidgetTester tester) async {
    int firstTapped = 0;
    int secondTapped = 0;
    final Key key = UniqueKey();
  ...
  testWidgets('SliverGrid.builder can build children',
      (WidgetTester tester) async {
    int firstTapped = 0;
    int secondTapped = 0;
    final Key key = UniqueKey();
