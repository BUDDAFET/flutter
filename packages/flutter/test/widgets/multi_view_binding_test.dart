...
void main() {
  testWidgets('runApp uses deprecated pipelineOwner and renderView',
  ...
  testWidgets('can manually attach RootWidget to build owner',
      (WidgetTester tester) async {
  ...
  testWidgets('runWidget throws if not given a View',
      (WidgetTester tester) async {
  ...
  testWidgets('runWidget does not throw if given a View',
      (WidgetTester tester) async {
    runWidget(
      View(
        view: FakeFlutterView(tester.view),
  ...
  testWidgets('can call runWidget with an empty ViewCollection',
      (WidgetTester tester) async {
