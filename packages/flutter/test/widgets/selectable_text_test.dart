...
void main() {
  ...
  testWidgets('Rich selectable text has expected defaults',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(),
  ...
  testWidgets('Rich selectable text supports WidgetSpan',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MediaQuery(
        data: MediaQueryData(),
  ...
  testWidgets('no text keyboard when widget is focused',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(
        child: const SelectableText('selectable text'),
  ...
  testWidgets('Selectable Text has adaptive size', (WidgetTester tester) async {
    ...
    RenderBox findSelectableTextBox() =>
        tester.renderObject(find.byType(SelectableText));
  ...
  testWidgets('can switch between textHeightBehavior',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'selectable text selection toolbar renders correctly inside opacity',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Scaffold(
  ...
  testWidgets('selectable text can disable toolbar options',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(
        child: const SelectableText(
  ...
  testWidgets('Dragging handles calls onSelectionChanged',
      (WidgetTester tester) async {
  ...
  testWidgets('Selectable height with maxLine', (WidgetTester tester) async {
    ...
    await tester
        .pumpWidget(selectableTextBuilder(text: kThreeLines, maxLines: 3));
    expect(findTextBox(), equals(textBox));
    expect(textBox.size.height, threeLineInputSize.height);

    // An extra line won't increase the size because we max at 3.
    await tester.pumpWidget(
        selectableTextBuilder(text: kMoreThanFourLines, maxLines: 3));
    expect(findTextBox(), equals(textBox));
    expect(textBox.size.height, threeLineInputSize.height);

    // But now it will... but it will max at four.
    await tester.pumpWidget(
        selectableTextBuilder(text: kMoreThanFourLines, maxLines: 4));
    expect(findTextBox(), equals(textBox));
    ...
    await tester
        .pumpWidget(selectableTextBuilder(text: kThreeLines, maxLines: null));
    expect(textBox.size.height, equals(threeLineInputSize.height));
    await tester.pumpWidget(
        selectableTextBuilder(text: kMoreThanFourLines, maxLines: null));
  ...
  testWidgets('minLines cannot be greater than maxLines',
      (WidgetTester tester) async {
    expect(
      () async {
        await tester.pumpWidget(
  ...
  testWidgets('Selectable height with minLine', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(selectableTextBuilder(
        text: 'No wrapping here.', minLines: 2, maxLines: 3));
    expect(findTextBox(), equals(textBox));
  ...
  testWidgets('Selectable text identifies as text field in semantics',
      (WidgetTester tester) async {
  ...
  testWidgets('Selectable text rich text with spell out in semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(
            child: SelectableText.rich(
                TextSpan(text: 'some text', spellOut: true)),
          ),
        ),
      ),
    );
  ...
  testWidgets('Selectable text rich text with locale in semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(
            child: SelectableText.rich(
                TextSpan(text: 'some text', locale: Locale('es', 'MX'))),
          ),
        ),
      ),
    );
  ...
  group('Keyboard Tests', () {
    ...
    Future<void> setupWidget(WidgetTester tester, String text) async {
      ...
      await tester.pumpAndSettle();
      final EditableText editableTextWidget =
          tester.widget(find.byType(EditableText).first);
  ...
  testWidgets('keyboard selection should call onSelectionChanged',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
    TextSelection? newSelection;
  ...
  testWidgets('Changing positions of selectable text',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
  ...
  testWidgets('Changing focus test', (WidgetTester tester) async {
    ...
    final EditableText editableTextWidget1 =
        tester.widget(find.byType(EditableText).first);
    final TextEditingController c1 = editableTextWidget1.controller;

    final EditableText editableTextWidget2 =
  ...
  testWidgets('SelectableText baseline alignment no-strut',
      (WidgetTester tester) async {
          ...
          children: <Widget>[
            Expanded(
              child: SelectableText(
                ...
                key: keyA,
                style:
                    const TextStyle(fontFamily: 'FlutterTest', fontSize: 10.0),
            ...
            Expanded(
              child: SelectableText(
                ...
                key: keyB,
                style:
                    const TextStyle(fontFamily: 'FlutterTest', fontSize: 30.0),
                strutStyle: StrutStyle.disabled,
              ),
            ),
          ],
  ...
  testWidgets('SelectableText semantics, with semanticsLabel',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final Key key = UniqueKey();
  ...
  testWidgets('SelectableText semantics for selections',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final Key key = UniqueKey();
  ...
  testWidgets('semantic nodes of offscreen recognizers are marked hidden',
    ...
    tester.binding.pipelineOwner.semanticsOwner!
        .performAction(8, SemanticsAction.showOnScreen);
    await tester.pumpAndSettle();
  ...
  testWidgets('SelectableText change selection with semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets(
      'Can activate SelectableText with explicit controller via semantics',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester
          .startGesture(selectableTextStart + const Offset(150.0, 5.0));
      // Hold the press.
      await tester.pump(const Duration(milliseconds: 500));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Rect selectableTextRect =
          tester.getRect(find.byType(SelectableText));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester
          .startGesture(selectableTextStart + const Offset(50.0, 5.0));
      await tester.pump(const Duration(milliseconds: 500));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture = await tester
          .startGesture(selectableTextStart + const Offset(200.0, 0.0));
...
//convert
  ...
  testWidgets('force press does not select a word on (android)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
    ...
    final Offset offset = tester.getTopLeft(find.byType(SelectableText)) +
        const Offset(150.0, 5.0);
  ...
  testWidgets('default SelectableText debugFillProperties',
      (WidgetTester tester) async {
  ...
  testWidgets('SelectableText implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset selectableTextPos =
  ...
  testWidgets(
      'text span with tap gesture recognizer works in selectable rich text',
      (WidgetTester tester) async {
    int spyTaps = 0;
  ...
  testWidgets(
      'text span with long press gesture recognizer works in selectable rich text',
      (WidgetTester tester) async {
    int spyLongPress = 0;
    ...
    expect(
      controller.selection,
      const TextSelection(
          baseOffset: 11, extentOffset: 11, affinity: TextAffinity.upstream),
    );
    // Long press triggers gesture recognizer.
    expect(spyLongPress, 1);
  });

  testWidgets('SelectableText changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgets('selecting a space selects the previous word on mobile',
      (WidgetTester tester) async {
  ...
  testWidgets('selecting a space selects the space on non-mobile platforms',
      (WidgetTester tester) async {
    TextSelection? selection;
  ...
  testWidgets('double tapping a space selects the previous word on mobile',
      (WidgetTester tester) async {
    TextSelection? selection;
  ...
  group('magnifier', () {
    ...
    testWidgets('Can drag handles to show, unshow, and update magnifier',
        (WidgetTester tester) async {
      const String testValue = 'abc def ghi';
      final SelectableText selectableText = SelectableText(testValue,
  ...
  testWidgets(
    ...
    const TextStyle textStyle =
        TextStyle(color: Color(0xff00ff00), fontSize: 12.0);
  ...
  testWidgets("Off-screen selected text doesn't throw exception",
      (WidgetTester tester) async {
    ...
    final TestGesture gesture =
        await tester.startGesture(selectableTextStart + const Offset(50, 5));
    await tester.pump(const Duration(milliseconds: 500));
    await gesture.up();
