...
void main() {
  test('Element diagnostics json includes widgetRuntimeType', () async {
    ...
    final Map<String, Object?> json = element
        .toDiagnosticsNode()
  ...
  group('Serialization', () {
        ...
        TestTree(
          ...
          children: <TestTree>[
            ...
            TestTree(
              name: 'node B2',
              properties: <DiagnosticsNode>[
                StringProperty('property1', 'value1', quoted: false)
              ],
            ),
            TestTree(
              name: 'node B3',
    ...
    test('subtreeDepth 1', () {
      final Map<String, Object?> result = testTree
          .toDiagnosticsNode()
          .toJsonMap(const DiagnosticsSerializationDelegate(subtreeDepth: 1));
      expect(result.containsKey('properties'), isFalse);
      final List<Map<String, Object?>> children =
          result['children']! as List<Map<String, Object?>>;
    ...
    test('subtreeDepth 5', () {
      final Map<String, Object?> result = testTree
          .toDiagnosticsNode()
          .toJsonMap(const DiagnosticsSerializationDelegate(subtreeDepth: 5));
      expect(result.containsKey('properties'), isFalse);
      final List<Map<String, Object?>> children =
          result['children']! as List<Map<String, Object?>>;
    ...
    test('additionalNodeProperties', () {
      final Map<String, Object?> result = testTree
          .toDiagnosticsNode()
          .toJsonMap(const TestDiagnosticsSerializationDelegate(
            includeProperties: true,
            subtreeDepth: 1,
      ...
      expect(
          properties.every(
              (Map<String, Object?> property) => property['foo'] == true),
          isTrue);
      ...
      expect(children, hasLength(3));
      expect(
          children.every((Map<String, Object?> child) => child['foo'] == true),
          isTrue);
    });
    ...
    test('filterProperties - sublist', () {
      ...
      expect(
          properties.every((Map<String, Object?> property) =>
      ...
      final Map<String, Object?> result = testTree
          ...
          .toJsonMap(TestDiagnosticsSerializationDelegate(
            ...
            childFilter: (List<DiagnosticsNode> nodes, DiagnosticsNode owner) {
              return nodes
                  .where((DiagnosticsNode node) => node.getProperties().isEmpty)
                  .toList();
            },
          ));
      final List<Map<String, Object?>> children =
    ...
    test('filterChildren - replace', () {
      final Map<String, Object?> result = testTree
          ...
          .toJsonMap(TestDiagnosticsSerializationDelegate(
            ...
            childFilter: (List<DiagnosticsNode> nodes, DiagnosticsNode owner) {
              return nodes
                  .expand((DiagnosticsNode node) => node.getChildren())
                  .toList();
            },
          ));
      final List<Map<String, Object?>> children =
    ...
    test('delegateForAddingNodes', () {
      final Map<String, Object?> result = testTree
          ...
          .toJsonMap(TestDiagnosticsSerializationDelegate(
            subtreeDepth: 5,
            includeProperties: true,
            nodeDelegator: (DiagnosticsNode node,
      ...
      expect(
          properties.every((Map<String, Object?> property) =>
              !property.containsKey('properties')),
          isTrue);
      ...
      expect(
          children.every(
              (Map<String, Object?> child) => !child.containsKey('properties')),
          isTrue);
    });
  });
}
...
typedef NodeDelegator = DiagnosticsSerializationDelegate Function(
    DiagnosticsNode node, TestDiagnosticsSerializationDelegate delegate);
typedef NodeTruncator = List<DiagnosticsNode> Function(
    List<DiagnosticsNode> nodes, DiagnosticsNode? owner);
typedef NodeFilter = List<DiagnosticsNode> Function(
    List<DiagnosticsNode> nodes, DiagnosticsNode owner);

class TestDiagnosticsSerializationDelegate
