...
void main() {
  ...
  testWidgets('Material3 - Does tooltip end up in the right place - top left',
    ...
    expect(tip.size.height,
        equals(30.0)); // 20.0 height + 5.0 padding * 2 (top, bottom)
    expect(tip.localToGlobal(tip.size.topLeft(Offset.zero)),
        equals(const Offset(10.0, 20.0)));
  },
      skip: kIsWeb &&
  ...
  testWidgets(
      'Material2 - Does tooltip end up in the right place - way off to the right',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
    addTearDown(() => entry
  ...
  testWidgets(
    ...
    expect(
        tip.localToGlobal(tip.size.bottomRight(Offset.zero)).dx, equals(790.0));
    expect(
        tip.localToGlobal(tip.size.bottomRight(Offset.zero)).dy, equals(330.0));
  },
      skip: kIsWeb &&
          !isSkiaWeb); // https://github.com/flutter/flutter/issues/99933

  testWidgets(
      'Material2 - Does tooltip end up in the right place - near the edge',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
    addTearDown(() => entry
  ...
  testWidgets(
      'Material3 - Does tooltip end up in the right place - near the edge',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
    addTearDown(() => entry
  ...
  testWidgets('Custom tooltip margin', (WidgetTester tester) async {
    ...
    final Offset topLeftTooltipContentInGlobal =
        tester.getTopLeft(find.text(tooltipText));
    expect(topLeftTooltipContentInGlobal.dx,
        topLeftTipInGlobal.dx + customMarginValue);
    expect(topLeftTooltipContentInGlobal.dy,
        topLeftTipInGlobal.dy + customMarginValue);

    final Offset topRightTipInGlobal = tester.getTopRight(
      _findTooltipContainer(tooltipText),
    );
    final Offset topRightTooltipContentInGlobal =
        tester.getTopRight(find.text(tooltipText));
    expect(topRightTooltipContentInGlobal.dx,
        topRightTipInGlobal.dx - customMarginValue);
    expect(topRightTooltipContentInGlobal.dy,
        topRightTipInGlobal.dy + customMarginValue);

    final Offset bottomLeftTipInGlobal = tester.getBottomLeft(
      _findTooltipContainer(tooltipText),
    );
    final Offset bottomLeftTooltipContentInGlobal =
        tester.getBottomLeft(find.text(tooltipText));
    expect(bottomLeftTooltipContentInGlobal.dx,
        bottomLeftTipInGlobal.dx + customMarginValue);
    expect(bottomLeftTooltipContentInGlobal.dy,
        bottomLeftTipInGlobal.dy - customMarginValue);

    final Offset bottomRightTipInGlobal = tester.getBottomRight(
      _findTooltipContainer(tooltipText),
    );
    final Offset bottomRightTooltipContentInGlobal =
        tester.getBottomRight(find.text(tooltipText));
    expect(bottomRightTooltipContentInGlobal.dx,
        bottomRightTipInGlobal.dx - customMarginValue);
    expect(bottomRightTooltipContentInGlobal.dy,
        bottomRightTipInGlobal.dy - customMarginValue);
  });

  testWidgets('Material2 - Default tooltip message textStyle - light',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    ...
    expect(textStyle.debugLabel,
        '((englishLike bodyMedium 2014).merge(blackMountainView bodyMedium)).copyWith');
  });

  testWidgets('Material3 - Default tooltip message textStyle - light',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    await tester.pumpWidget(MaterialApp(
      home: Tooltip(
  ...
  testWidgets('Material2 - Default tooltip message textStyle - dark',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    await tester.pumpWidget(MaterialApp(
      theme: ThemeData(
  ...
  testWidgets('Material3 - Default tooltip message textStyle - dark',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('Tooltip overlay respects ambient Directionality',
      (WidgetTester tester) async {
    ...
    RenderParagraph tooltipRenderParagraph =
        tester.renderObject<RenderParagraph>(find.text(tooltipText));
  ...
  testWidgets(
      'Tooltip overlay wrapped with a non-fallback DefaultTextStyle widget',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Material2 - Does tooltip end up with the right default size, shape, and color',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
    addTearDown(() => entry
    ...
    final RenderBox tip =
        tester.renderObject(_findTooltipContainer(tooltipText));
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(
                tip.paintBounds, const Radius.circular(4.0)),
            color: const Color(0xe6616161),
          ));

    final Container tooltipContainer =
        tester.firstWidget<Container>(_findTooltipContainer(tooltipText));
    expect(tooltipContainer.padding,
        const EdgeInsets.symmetric(horizontal: 16.0, vertical: 4.0));
  });

  testWidgets(
      'Material3 - Does tooltip end up with the right default size, shape, and color',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
    addTearDown(() => entry
  ...
  testWidgets(
    ...
    final RenderParagraph tooltipRenderParagraph =
        tester.renderObject<RenderParagraph>(find.text(tooltipText));
    ...
    expect(
        ...
        paints
          ..rrect(
            rrect: RRect.fromRectAndRadius(
                tooltipRenderBox.paintBounds, const Radius.circular(4.0)),
            color: const Color(0xe6616161),
          ));
  ...
  testWidgets(
    ...
    skip:
        kIsWeb && !isSkiaWeb, // https://github.com/flutter/flutter/issues/99933
  );

  testWidgets('Material2 - Can tooltip decoration be customized',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
  ...
  testWidgets('Material3 - Can tooltip decoration be customized',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    const Decoration customDecoration = ShapeDecoration(
      shape: StadiumBorder(),
  ...
  testWidgets('Tooltip is dismissed after tap to dismiss immediately',
      (WidgetTester tester) async {
    await setWidgetForTooltipMode(tester, TooltipTriggerMode.tap);
  ...
  testWidgets(
      'Tooltip is not dismissed after tap if enableTapToDismiss is false',
      (WidgetTester tester) async {
    await setWidgetForTooltipMode(tester, TooltipTriggerMode.tap,
  ...
  testWidgets('Dispatch the mouse events before tip overlay detached',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Tooltip shows without delay when the mouse moves from another tooltip',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    Future<void> performSequence(
        Iterable<Future<void> Function()> actions) async {
    ...
    await performSequence(
        <Future<void> Function()>[mouseEnterAndWaitUntilVisible]);
    expect(find.text(tooltipText), findsOne);
  ...
  testWidgets('Tooltip can be dismissed by escape key',
      (WidgetTester tester) async {
    const Duration waitDuration = Duration.zero;
    TestGesture? gesture =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
  ...
  testWidgets('Multiple Tooltips are dismissed by escape key',
      (WidgetTester tester) async {
    const Duration waitDuration = Duration.zero;
    await tester.pumpWidget(
      const MaterialApp(
    ...
    tester
        .state<TooltipState>(find.byTooltip('message1'))
        .ensureTooltipVisible();
    tester
        .state<TooltipState>(find.byTooltip('message2'))
        .ensureTooltipVisible();
    await tester.pump();
    await tester.pump(waitDuration);
  ...
  testWidgets('Tooltip does not attempt to show after unmount',
      (WidgetTester tester) async {
  ...
  testWidgets('Tooltip semantics does not merge into child',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
    late final OverlayEntry entry;
  ...
  testWidgets('Material2 - Tooltip text scales with textScaler',
      (WidgetTester tester) async {
    ...
    await tester
        .pumpWidget(buildApp(tooltipText, textScaler: TextScaler.noScaling));
    await tester.longPress(find.byType(Tooltip));
    expect(find.text(tooltipText), findsOneWidget);
    expect(
    ...
    await tester.pumpWidget(
        buildApp(tooltipText, textScaler: const TextScaler.linear(4.0)));
    await tester.longPress(find.byType(Tooltip));
    expect(find.text(tooltipText), findsOneWidget);
  ...
  testWidgets('Material3 - Tooltip text scales with textScaleFactor',
      (WidgetTester tester) async {
    Widget buildApp(String text, {required TextScaler textScaler}) {
      return MaterialApp(
        home: MediaQuery(
  ...
  testWidgets('Tooltip text displays with richMessage',
      (WidgetTester tester) async {
    final GlobalKey<TooltipState> tooltipKey = GlobalKey<TooltipState>();
  ...
  testWidgets('default Tooltip debugFillProperties with richMessage',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets('Tooltip implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets('Tooltip triggers on tap when trigger mode is tap',
      (WidgetTester tester) async {
    await setWidgetForTooltipMode(tester, TooltipTriggerMode.tap);
  ...
  testWidgets('Tooltip does not trigger when trigger mode is manual',
      (WidgetTester tester) async {
  ...
  testWidgets('Tooltip onTriggered is called when Tooltip triggers',
      (WidgetTester tester) async {
  ...
  testWidgets('dismissAllToolTips dismisses hovered tooltips',
      (WidgetTester tester) async {
    const Duration waitDuration = Duration.zero;
    final TestGesture gesture =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
  ...
  testWidgets('Hovered tooltips do not dismiss after showDuration',
      (WidgetTester tester) async {
    const Duration waitDuration = Duration.zero;
    final TestGesture gesture =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
  ...
  testWidgets(
      'Hovered tooltips with showDuration set do dismiss when hovering elsewhere',
      (WidgetTester tester) async {
    const Duration waitDuration = Duration.zero;
    const Duration showDuration = Duration(seconds: 1);
    ...
    expect(find.text(tooltipText), findsNothing,
        reason:
            'Tooltip should not wait for showDuration before it hides itself.');
  });

  testWidgets('Hovered tooltips hide after stopping the hover',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Center(
  ...
  testWidgets(
      'Hovered tooltips hide after stopping the hover and exitDuration expires',
      (WidgetTester tester) async {
    ...
    expect(find.text(tooltipText), findsOneWidget,
        reason:
            'Tooltip should wait until exitDuration expires before being hidden');
  ...
  testWidgets('Tooltip trigger mode ignores mouse events',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Tooltip(
    ...
    final TestGesture touchGesture = await tester
        .startGesture(tester.getCenter(find.byTooltip(tooltipText)));
    await tester.pump(kLongPressTimeout + kPressTimeout);
  ...
  testWidgets('Tooltip does not block other mouse regions',
      (WidgetTester tester) async {
    bool entered = false;
  ...
  testWidgets('Does not rebuild on mouse connect/disconnect',
      (WidgetTester tester) async {
  ...
  testWidgets('Tooltip should not ignore users tap on richMessage',
      (WidgetTester tester) async {
    bool isTapped = false;
  ...
  testWidgets('Hold mouse button down and hover over the Tooltip widget',
    ...
    expect(
      ...
      findsOneWidget,
      reason:
          'Tooltip should be visible even when there is a PointerUp when hovered.',
    );
  ...
  testWidgets('Hovered text should dismiss when clicked outside',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Center(
    ...
    final TestGesture mouseGesture1 =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
    ...
    final TestGesture mouseGesture2 =
        await tester.createGesture(kind: PointerDeviceKind.mouse);
    ...
    expect(find.text(tooltipText), findsNothing,
        reason:
            'Tapping outside of the Tooltip widget should dismiss the tooltip.');
  });

  testWidgets('Mouse tap and hover over the Tooltip widget',
      (WidgetTester tester) async {
    ...
    expect(
      ...
      findsNothing,
      reason:
          'Tooltip should NOT be visible when hovered and tapped, when trigger mode is not tap',
    );
    ...
    expect(
      ...
      findsNothing,
      reason:
          'Tooltip should NOT be visible when hovered and tapped, when trigger mode is tap',
    );
  });
  ...
  testWidgets(
      'Tooltip does not initialize animation controller in dispose process',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Center(
  ...
  testWidgets('Tooltip is not selectable', (WidgetTester tester) async {
    ...
    await gesture.moveTo(
        Alignment.centerRight.alongSize(textRect.size) + textRect.topLeft);
    await tester.pump();
    ...
    await gesture.moveTo(Alignment.centerLeft.alongSize(tooltipTextRect.size) +
        tooltipTextRect.topLeft);
    await tester.pump();
    await gesture.moveTo(Alignment.centerRight.alongSize(tooltipTextRect.size) +
        tooltipTextRect.topLeft);
    await tester.pump();
...
Future<void> _testGestureLongPress(WidgetTester tester, Finder tooltip) async {
  final TestGesture gestureLongPress =
      await tester.startGesture(tester.getCenter(tooltip));
  await tester.pump();
  await tester.pump(kLongPressTimeout);
