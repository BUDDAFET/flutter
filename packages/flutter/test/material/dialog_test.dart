...
void main() {
  ...
  testWidgets('Dialog background color from AlertDialog',
  ...
  testWidgets('Dialog background defaults to ColorScheme.surface',
      (WidgetTester tester) async {
  ...
  testWidgets('Material2 - Dialog.fullscreen Defaults',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Dialog.fullscreen Defaults',
      (WidgetTester tester) async {
  ...
  testWidgets('AlertDialog.actionsPadding defaults',
      (WidgetTester tester) async {
    final AlertDialog dialog = AlertDialog(
      title: const Text('title'),
  ...
  testWidgets('Material2 - AlertDialog.buttonPadding defaults',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - AlertDialog.buttonPadding defaults',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgets('AlertDialog.buttonPadding custom values',
      (WidgetTester tester) async {
    final GlobalKey key1 = GlobalKey();
    final GlobalKey key2 = GlobalKey();
  ...
  testWidgets('AlertDialog has correct semantics for content in iOS',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Dismissible.confirmDismiss defers to an AlertDialog',
      (WidgetTester tester) async {
    ...
    await dismissItem(
        tester, 0); // Causes the AlertDialog to appear per confirmDismiss
    await tester.pumpAndSettle();
    ...
    expect(dismissedItems, <int>[0]);
    await dismissItem(
        tester, 1); // Causes the AlertDialog to appear per confirmDismiss
    await tester.pumpAndSettle();
  ...
  testWidgets('AlertDialog.insetPadding is nullable',
      (WidgetTester tester) async {
    const AlertDialog alertDialog = AlertDialog();
    expect(alertDialog.insetPadding, isNull);
  });

  testWidgets('SimpleDialog.insetPadding is nullable',
      (WidgetTester tester) async {
