...
class TestMaterialLocalizationsDelegate
...
void main() {
  ...
  group('InputDatePickerFormField', () {
    ...
    testWidgets('Changing initial date is reflected in text value',
    ...
    testWidgets('Invalid text entry shows errorFormat text',
        (WidgetTester tester) async {
      final GlobalKey<FormState> formKey = GlobalKey<FormState>();
      DateTime? inputDate;
      await tester.pumpWidget(inputDatePickerField(
    ...
    testWidgets('Empty field shows hint text when focused',
        (WidgetTester tester) async {
      await tester.pumpWidget(inputDatePickerField());
      // Focus on it
      ...
      await tester
          .pumpWidget(inputDatePickerField(fieldHintText: 'Enter some date'));
      await tester.pumpAndSettle();
  ...
  testWidgets('FocusNode can request focus', (WidgetTester tester) async {
    ...
    expect((tester.widget(find.byType(TextField)) as TextField).focusNode,
        focusNode);
