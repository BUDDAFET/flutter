...
void main() {
  testWidgets('OutlinedButton, OutlinedButton.icon defaults',
    ...
    expect(material.shadowColor,
        material3 ? Colors.transparent : const Color(0xff000000));
    ...
    if (!material3) {
      ...
      expect(inkFeatures,
          paints..circle(color: colorScheme.primary.withOpacity(0.12)));
    }
  ...
  testWidgets(
      'OutlinedButton.icon produces the correct widgets if icon is null',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
    final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
    final Key iconButtonKey = UniqueKey();
  ...
  testWidgets('OutlinedButton default overlayColor resolves pressed state',
    ...
    await tester.pumpAndSettle();
    expect(overlayColor(),
        paints..rect(color: theme.colorScheme.primary.withOpacity(0.1)));

    focusNode.dispose();
  });

  testWidgets('Does OutlinedButton work with hover',
      (WidgetTester tester) async {
  ...
  testWidgets('Does OutlinedButton work with focus',
      (WidgetTester tester) async {
    ...
    expect(
        material.shape, StadiumBorder(side: BorderSide(color: colors.primary)));

    focusNode.dispose();
  });

  testWidgets('Does OutlinedButton work with autofocus',
      (WidgetTester tester) async {
    final ThemeData theme = ThemeData();
    final ColorScheme colors = theme.colorScheme;
    const Color focusColor = Color(0xff001122);
  ...
  testWidgets(
    ...
    Color textColor() {
      return tester
          .renderObject<RenderParagraph>(find.text('OutlinedButton'))
          .text
          .style!
          .color;
    }
        ...
        home: Scaffold(
          body: Center(
            child: OutlinedButton.icon(
              ...
              style: ButtonStyle(
                foregroundColor:
                    MaterialStateProperty.resolveWith<Color>(getIconColor),
              ),
              icon: const Icon(Icons.add),
          ...
          body: Center(
            child: OutlinedButton(
              style: ButtonStyle(
                ...
                shape: ButtonStyleButton.allOrNull(const RoundedRectangleBorder(
  ...
  testWidgets("OutlinedButton response doesn't hover when disabled",
      (WidgetTester tester) async {
    FocusManager.instance.highlightStrategy =
  ...
  testWidgets('disabled and hovered OutlinedButton responds to mouse-exit',
    ...
    await gesture.moveTo(
        tester.getCenter(find.byType(OutlinedButton)) - const Offset(1, 1));
    await tester.pumpAndSettle();
  ...
  testWidgets('Can set OutlinedButton focus and Can set unFocus.',
      (WidgetTester tester) async {
    ...
    Widget buildFrame(VoidCallback? onPressed) {
      return Directionality(
        ...
        child: Theme(
          ...
          child: Center(
            child: OutlinedButton(
                onPressed: onPressed, child: const Text('button')),
          ),
        ),
      );
    }
  ...
  testWidgets('OutlinedButton shape and border component overrides',
      (WidgetTester tester) async {
    const Color fillColor = Color(0xFF00FF00);
    const BorderSide disabledBorderSide =
        BorderSide(color: Color(0xFFFF0000), width: 3);
    const BorderSide enabledBorderSide =
        BorderSide(color: Color(0xFFFF00FF), width: 4);
    const BorderSide pressedBorderSide =
        BorderSide(color: Color(0xFF0000FF), width: 5);
          ...
          child: Container(
            ...
            child: OutlinedButton(
              style: OutlinedButton.styleFrom(
                shape:
                    const RoundedRectangleBorder(), // default border radius is 0
    ...
    BorderSide getBorderSide() {
      final OutlinedBorder border = tester
          .widget<Material>(
            find.descendant(
                of: outlinedButton, matching: find.byType(Material)),
          )
  ...
  testWidgets('OutlinedButton has no clip by default',
      (WidgetTester tester) async {
  ...
  testWidgets('OutlinedButton contributes semantics',
      (WidgetTester tester) async {
  ...
  testWidgets('OutlinedButton scales textScaleFactor',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: ThemeData(useMaterial3: false),
    ...
    expect(tester.getSize(find.byType(OutlinedButton)),
        equals(const Size(88.0, 48.0)));
    ...
    expect(
        tester.getSize(find.byType(OutlinedButton)), const Size(134.0, 48.0));
    expect(tester.getSize(find.byType(Text)), const Size(126.0, 42.0));
  },
      skip: kIsWeb &&
          !isSkiaWeb); // https://github.com/flutter/flutter/issues/122066
  ...
  testWidgets('OutlinedButton responds to density changes.',
      (WidgetTester tester) async {
      ...
      for (final TextDirection textDirection in textDirectionOptions) {
        for (final Widget? icon in iconOptions) {
          ...
          testWidgets(testName, (WidgetTester tester) async {
            ...
            final double expectedPaddingBottom =
                paddingVertical[textScaleFactor]!;
            ...
            expect(
                paddingWidget.padding.resolve(textDirection), expectedPadding);
            ...
            expect(
                textHeight, moreOrLessEquals(expectedTextHeight, epsilon: 0.5));
          });
        }
      }
    }
  ...
  testWidgets('Override OutlinedButton default padding',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgets('Override theme fontSize changes padding',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('M3 OutlinedButton has correct padding',
      (WidgetTester tester) async {
  ...
  testWidgets('M3 OutlinedButton.icon has correct padding',
      (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Fixed size OutlinedButtons', (WidgetTester tester) async {
        ...
        home: Scaffold(
          body: Column(
            ...
            children: <Widget>[
              OutlinedButton(
                style:
                    OutlinedButton.styleFrom(fixedSize: const Size(100, 100)),
                onPressed: () {},
    ...
    expect(tester.getSize(find.widgetWithText(OutlinedButton, '100x100')),
        const Size(100, 100));
    expect(tester.getSize(find.widgetWithText(OutlinedButton, '200xh')).width,
        200);
    expect(tester.getSize(find.widgetWithText(OutlinedButton, 'wx200')).height,
        200);
  });
  ...
  testWidgets('OutlinedButton.icon does not overflow',
      (WidgetTester tester) async {
  ...
  testWidgets('OutlinedButton.icon icon,label layout',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgets('Fixed size OutlinedButton, same as minimumSize == maximumSize',
        ...
        home: Scaffold(
          body: Column(
            ...
            children: <Widget>[
              OutlinedButton(
                style:
                    OutlinedButton.styleFrom(fixedSize: const Size(200, 200)),
                onPressed: () {},
    ...
    expect(tester.getSize(find.widgetWithText(OutlinedButton, '200x200')),
        const Size(200, 200));
    expect(tester.getSize(find.widgetWithText(OutlinedButton, '200,200')),
        const Size(200, 200));
  });

  testWidgets('OutlinedButton changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets(
      'OutlinedButton in SelectionArea changes mouse cursor when hovered',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'OutlinedButton.styleFrom can be used to set foreground and background colors',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('OutlinedButton.icon statesController',
      (WidgetTester tester) async {
    testStatesController(const Icon(Icons.add), tester);
  });

  testWidgets('Disabled OutlinedButton statesController',
      (WidgetTester tester) async {
    int count = 0;
    void valueChanged() {
      count += 1;
  ...
  testWidgets(
      "OutlinedButton.styleFrom doesn't throw exception on passing only one cursor",
      (WidgetTester tester) async {
  ...
  testWidgets('OutlinedButton backgroundBuilder and foregroundBuilder',
    ...
    await tester.pumpWidget(
      Directionality(
        ...
        child: OutlinedButton(
          style: OutlinedButton.styleFrom(
            backgroundBuilder: (BuildContext context, Set<MaterialState> states,
                Widget? child) {
              return DecoratedBox(
            ...
            foregroundBuilder: (BuildContext context, Set<MaterialState> states,
                Widget? child) {
              return DecoratedBox(
                decoration: const BoxDecoration(
  ...
  testWidgets('OutlinedButton foregroundBuilder drops button child',
      (WidgetTester tester) async {
    const Color foregroundColor = Color(0xFF000022);
  ...
  testWidgets(
            ...
            child: OutlinedButton(
              style: ButtonStyle(
                backgroundBuilder: (BuildContext context,
                    Set<MaterialState> states, Widget? child) {
    ...
    bool sameStates(
        Set<MaterialState> expectedValue, Set<MaterialState> actualValue) {
  ...
  testWidgets('OutlinedButton styleFrom backgroundColor special case',
      (WidgetTester tester) async {
  ...
  testWidgets('Default iconAlignment', (WidgetTester tester) async {
    ...
    expect(buttonTopLeft.dx,
        iconTopLeft.dx - 16.0); // 16.0 - padding between icon and button edge.
    ...
    final Offset buttonTopRight =
        tester.getTopRight(find.byType(Material).last);
    final Offset iconTopRight = tester.getTopRight(find.byIcon(Icons.add));

    // The icon is aligned to the right of the button.
    expect(buttonTopRight.dx,
        iconTopRight.dx + 16.0); // 16.0 - padding between icon and button edge.
  });
  ...
  testWidgets('iconAlignment can be customized', (WidgetTester tester) async {
    ...
    // The icon is aligned to the right of the button.
    expect(buttonTopRight.dx,
        iconTopRight.dx + 24.0); // 24.0 - padding between icon and button edge.
    ...
    // The icon is aligned to the left of the button.
    expect(buttonTopLeft.dx,
        iconTopLeft.dx - 24.0); // 24.0 - padding between icon and button edge.
  });
  ...
  testWidgets("OutlinedButton.icon response doesn't hover when disabled",
    ...
    final FocusNode focusNode =
        FocusNode(debugLabel: 'OutlinedButton.icon Focus');
    final GlobalKey childKey = GlobalKey();
    bool hovering = false;
    await tester.pumpWidget(
      Directionality(
  ...
  testWidgets('disabled and hovered OutlinedButton.icon responds to mouse-exit',
    ...
    await gesture
        .moveTo(tester.getCenter(find.byKey(key)) - const Offset(1, 1));
    await tester.pumpAndSettle();
    // Moving the mouse a little within the OutlinedButton doesn't change anything.
    expect(onHoverCount, 2);
    expect(hover, false);
  ...
  testWidgets('Can set OutlinedButton.icon focus and Can set unFocus.',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'When OutlinedButton.icon disable, Can not set OutlinedButton.icon focus.',
      (WidgetTester tester) async {
    final FocusNode node = FocusNode(debugLabel: 'OutlinedButton.icon Focus');
    bool gotFocus = false;
    await tester.pumpWidget(
