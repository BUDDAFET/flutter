...
void main() {
  testWidgets('TextButton, TextButton.icon defaults',
  ...
  testWidgets('TextButton.icon produces the correct widgets when icon is null',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
    final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
    final Key iconButtonKey = UniqueKey();
  ...
  testWidgets('TextButton default overlayColor resolves pressed state',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
  ...
  testWidgets(
    ...
    Color? textColor() {
      return tester
          .renderObject<RenderParagraph>(find.text('TextButton'))
          .text
          .style
          ?.color;
    }
  ...
  testWidgets('Does TextButton contribute semantics',
      (WidgetTester tester) async {
  ...
  testWidgets('Does TextButton scale with font scale changes',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
    ...
    expect(tester.getSize(find.byType(TextButton)),
        equals(const Size(64.0, 48.0)));
    ...
    expect(tester.getSize(find.byType(Text)), const Size(126.0, 42.0));
      ...
      skip: kIsWeb &&
          !isSkiaWeb); // https://github.com/flutter/flutter/issues/61016
  ...
  testWidgets(
    ...
    Widget buildFrame(MaterialTapTargetSize tapTargetSize, Key key) {
      return Theme(
        data: ThemeData(
            useMaterial3: false, materialTapTargetSize: tapTargetSize),
        child: Directionality(
          textDirection: TextDirection.ltr,
          child: Center(
            child: TextButton(
  ...
  testWidgets("TextButton response doesn't hover when disabled",
      (WidgetTester tester) async {
  ...
  testWidgets('disabled and hovered TextButton responds to mouse-exit',
      (WidgetTester tester) async {
    int onHoverCount = 0;
    late bool hover;
    ...
    await gesture
        .moveTo(tester.getCenter(find.byType(TextButton)) - const Offset(1, 1));
    await tester.pumpAndSettle();
  ...
  testWidgets('Can set TextButton focus and Can set unFocus.',
      (WidgetTester tester) async {
  ...
  testWidgets('When TextButton disable, Can not set TextButton focus.',
      (WidgetTester tester) async {
    final FocusNode node = FocusNode(debugLabel: 'TextButton Focus');
    bool gotFocus = false;
    await tester.pumpWidget(
  ...
  testWidgets('TextButton responds to density changes.',
      (WidgetTester tester) async {
  ...
  group('Default TextButton padding for textScaleFactor, textDirection', () {
    ...
    final Map<double, double> textPaddingWithoutIconHorizontal =
        <double, double>{
      0.5: 8,
      1: 8,
      1.25: 8,
              ...
              MaterialApp(
                theme: ThemeData(
                  ...
                  textButtonTheme: TextButtonThemeData(
                    style:
                        TextButton.styleFrom(minimumSize: const Size(64, 36)),
                  ),
                ),
                home: Builder(
                  builder: (BuildContext context) {
  ...
  testWidgets('Override TextButton default padding',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData.from(colorScheme: const ColorScheme.light()),
            ...
            return MediaQuery.withClampedTextScaling(
              ...
              child: Scaffold(
                body: Center(
                  child: TextButton(
                    style:
                        TextButton.styleFrom(padding: const EdgeInsets.all(22)),
                    onPressed: () {},
                    child: const Text('TextButton'),
                  ),
                ),
  ...
  testWidgets('M3 TextButton has correct default padding',
      (WidgetTester tester) async {
  ...
  testWidgets('M3 TextButton.icon has correct default padding',
      (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Fixed size TextButtons', (WidgetTester tester) async {
        ...
        home: Scaffold(
          body: Column(
            ...
            children: <Widget>[
              ...
              TextButton(
                style:
                    TextButton.styleFrom(fixedSize: const Size.fromWidth(200)),
                onPressed: () {},
                child: const Text('200xh'),
              ),
              TextButton(
                style:
                    TextButton.styleFrom(fixedSize: const Size.fromHeight(200)),
                onPressed: () {},
    ...
    expect(tester.getSize(find.widgetWithText(TextButton, '100x100')),
        const Size(100, 100));
    expect(tester.getSize(find.widgetWithText(TextButton, '200xh')).width, 200);
    expect(
        tester.getSize(find.widgetWithText(TextButton, 'wx200')).height, 200);
  });

  testWidgets('TextButton with NoSplash splashFactory paints nothing',
      (WidgetTester tester) async {
  ...
  testWidgets('TextButton uses InkRipple when useMaterial3 is false',
      (WidgetTester tester) async {
  ...
  testWidgets('Fixed size TextButton, same as minimumSize == maximumSize',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
    ...
    expect(tester.getSize(find.widgetWithText(TextButton, '200x200')),
        const Size(200, 200));
    expect(tester.getSize(find.widgetWithText(TextButton, '200,200')),
        const Size(200, 200));
  });

  testWidgets('TextButton changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets(
      'TextButton.styleFrom can be used to set foreground and background colors',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('Disabled TextButton statesController',
      (WidgetTester tester) async {
    int count = 0;
    void valueChanged() {
      count += 1;
  ...
  testWidgets('icon color can be different from the text color',
      (WidgetTester tester) async {
    final Key iconButtonKey = UniqueKey();
    const ColorScheme colorScheme = ColorScheme.light();
    final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
      ...
      MaterialApp(
        ...
        home: Center(
          child: TextButton.icon(
            key: iconButtonKey,
            style: TextButton.styleFrom(
                iconColor: Colors.red, disabledIconColor: Colors.blue),
            icon: const Icon(Icons.add),
            onPressed: null,
            label: const Text('button'),
          ),
  ...
  testWidgets(
      "TextButton.styleFrom doesn't throw exception on passing only one cursor",
      (WidgetTester tester) async {
  ...
  testWidgets('TextButton backgroundBuilder and foregroundBuilder',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'TextButton backgroundBuilder drops button child and foregroundBuilder return value',
      (WidgetTester tester) async {
    const Color backgroundColor = Color(0xFF000011);
    const Color foregroundColor = Color(0xFF000022);
  ...
  testWidgets('TextButton foregroundBuilder drops button child',
      (WidgetTester tester) async {
    const Color foregroundColor = Color(0xFF000022);
  ...
  testWidgets(
      'TextButton foreground and background builders are applied to the correct states',
      (WidgetTester tester) async {
  ...
  testWidgets('TextButton styleFrom backgroundColor special case',
      (WidgetTester tester) async {
  ...
  testWidgets('Default iconAlignment', (WidgetTester tester) async {
    ...
    expect(buttonTopLeft.dx,
        iconTopLeft.dx - 12.0); // 12.0 - padding between icon and button edge.
    ...
    expect(buttonTopRight.dx,
        iconTopRight.dx + 12.0); // 12.0 - padding between icon and button edge.
  });
  ...
  testWidgets('treats a hovering stylus like a mouse',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
