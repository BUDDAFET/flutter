...
void main() {
  ...
  testWidgets('Material2 - BottomNavigationBar content test',
  ...
  testWidgets('Material3 - BottomNavigationBar content test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('Material2 - Fixed BottomNavigationBar defaults',
      (WidgetTester tester) async {
    ...
    expect(
      tester
          .firstWidget<Transform>(find.ancestor(
              of: find.text('Alarm'), matching: find.byType(Transform)))
          .transform,
      equals(Matrix4.diagonal3(
          Vector3.all(unselectedFontSize / selectedFontSize))),
    );
  ...
  testWidgets('Material3 - Fixed BottomNavigationBar defaults',
      (WidgetTester tester) async {
    const Color primaryColor = Color(0xFF000001);
    const Color unselectedWidgetColor = Color(0xFF000002);
  ...
  testWidgets('Custom selected and unselected font styles',
      (WidgetTester tester) async {
    ...
    expect(
      tester
          .firstWidget<Transform>(find.ancestor(
              of: find.text('Alarm'), matching: find.byType(Transform)))
          .transform,
      equals(Matrix4.diagonal3(Vector3.all(
          unselectedTextStyle.fontSize! / selectedTextStyle.fontSize!))),
    );
    expect(
        unselectedFontStyle.fontWeight, equals(unselectedTextStyle.fontWeight));
  });

  testWidgets('font size on text styles overrides font size params',
      (WidgetTester tester) async {
  ...
  testWidgets('Custom selected and unselected icon themes',
      (WidgetTester tester) async {
    const IconThemeData selectedIconTheme =
        IconThemeData(size: 36, color: Color(0x00000001));
  ...
  testWidgets('Padding is calculated properly on items - all labels',
      (WidgetTester tester) async {
    const double selectedFontSize = 16.0;
    const double selectedIconSize = 36.0;
    const double unselectedIconSize = 20.0;
    const IconThemeData selectedIconTheme =
        IconThemeData(size: selectedIconSize);
    const IconThemeData unselectedIconTheme =
        IconThemeData(size: unselectedIconSize);
    ...
    final EdgeInsets unselectedItemPadding =
        _itemPadding(tester, Icons.access_alarm);
  ...
  testWidgets('Padding is calculated properly on items - selected labels only',
    ...
    expect(
        ...
        equals(
            (selectedIconSize - unselectedIconSize) / 2.0 + selectedFontSize));
    expect(unselectedItemPadding.bottom,
        equals((selectedIconSize - unselectedIconSize) / 2.0));
  });

  testWidgets('Padding is calculated properly on items - no labels',
      (WidgetTester tester) async {
    const double selectedFontSize = 16.0;
    const double selectedIconSize = 36.0;
    const double unselectedIconSize = 20.0;
  ...
  testWidgets('Material2 - Shifting BottomNavigationBar defaults',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgets('Material3 - Shifting BottomNavigationBar defaults',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('Fixed BottomNavigationBar custom font size, color',
      (WidgetTester tester) async {
  ...
  testWidgets('Shifting BottomNavigationBar custom font size, color',
      (WidgetTester tester) async {
    const Color primaryColor = Color(0xFF000000);
    const Color unselectedWidgetColor = Color(0xFFD501FF);
    const Color selectedColor = Color(0xFF0004FF);
  ...
  testWidgets(
      'iconTheme color should override itemColor for BottomNavigationBarType.shifted',
      (WidgetTester tester) async {
    const Color primaryColor = Color(0xFF000000);
    const Color unselectedWidgetColor = Color(0xFFD501FF);
    const Color selectedLabelColor = Color(0xFFFF9900);
  ...
  testWidgets(
      'iconTheme color should override itemColor color for BottomNavigationBarType.fixed',
      (WidgetTester tester) async {
    const Color primaryColor = Color(0xFF000000);
    const Color unselectedWidgetColor = Color(0xFFD501FF);
    const Color selectedIconThemeColor = Color(0xFF1E7723);
  ...
  testWidgets('Fixed BottomNavigationBar can hide unselected labels',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets('Fixed BottomNavigationBar can update background color',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Shifting BottomNavigationBar background color is overridden by item color',
      (WidgetTester tester) async {
  ...
  testWidgets('setting selectedFontSize to zero hides all labels',
      (WidgetTester tester) async {
  ...
  testWidgets('Material2 - BottomNavigationBar adds bottom padding to height',
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: MediaQuery(
          data:
              const MediaQueryData(viewPadding: EdgeInsets.only(bottom: 40.0)),
          child: Scaffold(
            bottomNavigationBar: BottomNavigationBar(
              items: const <BottomNavigationBarItem>[
                BottomNavigationBarItem(
    ...
    expect(tester.getSize(find.byType(BottomNavigationBar)).height,
        expectedHeight);
  });
  ...
  testWidgets('BottomNavigationBar action size test',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets(
    ...
    expect(Theme.of(tester.element(find.text('Alarm'))).brightness,
  ...
  testWidgets('Material3 - BottomNavigationBar responds to textScaleFactor',
    ...
    final RenderBox shiftingBox =
        tester.renderObject(find.byType(BottomNavigationBar));
    // kBottomNavigationBarHeight is a minimum dimension.
    expect(shiftingBox.size.height,
        greaterThanOrEqualTo(kBottomNavigationBarHeight));
  ...
  testWidgets(
    ...
    expect(
        tester.getSize(find.text(label).last), equals(const Size(42.0, 14.0)));
    ...
    await tester.longPress(find.text(label));
    expect(
        tester.getSize(find.text(label).last), equals(const Size(168.0, 56.0)));
  });
  ...
  testWidgets('BottomNavigationBar limits width of tiles with long labels',
      (WidgetTester tester) async {
    final String longTextA =
        List<String>.generate(100, (int index) => 'A').toString();
    final String longTextB =
        List<String>.generate(100, (int index) => 'B').toString();
  ...
  testWidgets('Material2 - BottomNavigationBar paints circles',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        useMaterial3: false,
  ...
  testWidgets('BottomNavigationBar inactiveIcon shown',
      (WidgetTester tester) async {
  ...
  testWidgets('BottomNavigationBar.fixed semantics',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      boilerplate(
        textDirection: TextDirection.ltr,
    ...
    Widget buildFrame(int itemCount) {
      return MaterialApp(
        home: Scaffold(
          bottomNavigationBar: BottomNavigationBar(
            type: BottomNavigationBarType.fixed,
            items: List<BottomNavigationBarItem>.generate(itemCount,
                (int itemIndex) {
  ...
  testWidgets('BottomNavigationBar change backgroundColor test',
      (WidgetTester tester) async {
  ...
  group(
      'Material2 - BottomNavigationBar shifting backgroundColor with transition',
      () {
    ...
    for (int pump = 1; pump < 9; pump++) {
      testWidgets('pump $pump', (WidgetTester tester) async {
        ...
        await expectLater(
          ...
          matchesGoldenFile(
              'm2_bottom_navigation_bar.shifting_transition.${pump - 1}.png'),
        );
      });
    }
  });
  ...
  group(
      'Material3 - BottomNavigationBar shifting backgroundColor with transition',
      () {
    // Regression test for: https://github.com/flutter/flutter/issues/22226
    Widget runTest() {
      int currentIndex = 0;
    ...
    for (int pump = 1; pump < 9; pump++) {
      testWidgets('pump $pump', (WidgetTester tester) async {
        ...
        await expectLater(
          find.byType(BottomNavigationBar),
          matchesGoldenFile(
              'm3_bottom_navigation_bar.shifting_transition.${pump - 1}.png'),
        );
      });
    }
  });

  testWidgets('BottomNavigationBar item label should not be nullable',
      (WidgetTester tester) async {
    expect(() {
      MaterialApp(
        home: Scaffold(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(tester.widget<Visibility>(find.byType(Visibility).first).visible,
          false);
      expect(tester.widget<Visibility>(find.byType(Visibility).last).visible,
          false);
    },
  );
  ...
  group('feedback', () {
    ...
    Widget feedbackBoilerplate(
        {bool? enableFeedback, bool? enableFeedbackTheme}) {
      return MaterialApp(
        home: Scaffold(
    ...
    testWidgets('BottomNavigationBar with enabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgets('BottomNavigationBar with disabled feedback',
        (WidgetTester tester) async {
    ...
    testWidgets(
        'BottomNavigationBar with disabled feedback using BottomNavigationBarTheme',
        (WidgetTester tester) async {
      const bool enableFeedbackTheme = false;

      await tester.pumpWidget(
          feedbackBoilerplate(enableFeedbackTheme: enableFeedbackTheme));
  ...
  testWidgets('Material2 - BottomNavigationBar default layout',
      (WidgetTester tester) async {
    ...
    expect(tester.getRect(find.text('Title0')),
        const Rect.fromLTRB(158.0, 570.0, 242.0, 584.0));
    expect(tester.getRect(find.byKey(icon0)),
        const Rect.fromLTRB(100.0, 560.0, 300.0, 570.0));
    expect(tester.getRect(find.byKey(icon1)),
        const Rect.fromLTRB(500.0, 560.0, 700.0, 570.0));
  });

  testWidgets('Material3 - BottomNavigationBar default layout',
      (WidgetTester tester) async {
    final Key icon0 = UniqueKey();
    final Key icon1 = UniqueKey();
    ...
    final double labelHeight =
        (selectedFontSize * m3LineHeight).floorToDouble(); // 20
    ...
    const double iconTop = navigationBarTop +
        navigationTileVerticalOffset +
        navigationTileVerticalPadding;
    final double labelBottom =
        600 - (navigationTileVerticalOffset + navigationTileVerticalPadding);
            ...
            return Scaffold(
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: <BottomNavigationBarItem>[
                  BottomNavigationBarItem(
                    icon: SizedBox(
                        key: icon0, width: iconWidth, height: iconHeight),
                    label: 'Title0',
                  ),
                  BottomNavigationBarItem(
                    icon: SizedBox(
                        key: icon1, width: iconWidth, height: iconHeight),
                    label: 'Title1',
                  ),
                ],
              ),
  ...
  testWidgets('Material2 - BottomNavigationBar linear landscape layout',
    ...
    expect(tester.getRect(find.text('Title0')),
        const Rect.fromLTRB(212.0, 565.0, 296.0, 579.0));
    expect(tester.getRect(find.byKey(icon0)),
        const Rect.fromLTRB(104.0, 562.0, 204.0, 582.0));
    expect(tester.getRect(find.byKey(icon1)),
        const Rect.fromLTRB(504.0, 562.0, 604.0, 582.0));
  });
  ...
  testWidgets('Material3 - BottomNavigationBar linear landscape layout',
    ...
    final double firstLabelWidth = tester.getSize(find.text('Title0')).width;
    final double firstItemContentWidth =
        iconWidth + separatorWidth + firstLabelWidth;
    ...
    final double secondItemContentWidth =
        iconWidth + separatorWidth + secondLabelWidth;
    final double secondItemLeft =
        itemFullWith + itemFullWith / 2 - secondItemContentWidth / 2;
    ...
    expect(
        ...
        Rect.fromLTRB(firstItemLeft, iconTop, firstItemLeft + iconWidth,
            iconTop + iconHeight));
    expect(
        tester.getRect(find.byKey(icon1)),
        Rect.fromLTRB(secondItemLeft, iconTop, secondItemLeft + iconWidth,
            iconTop + iconHeight));
  },
      skip: kIsWeb &&
          !isSkiaWeb); // https://github.com/flutter/flutter/issues/99933
  ...
  testWidgets(
      'BottomNavigationBar linear landscape layout label RenderFlex overflow',
      (WidgetTester tester) async {
  ...
  testWidgets('BottomNavigationBar keys passed through',
      (WidgetTester tester) async {
...
Material _getMaterial(WidgetTester tester) {
  return tester.firstWidget<Material>(
    find.descendant(
        of: find.byType(BottomNavigationBar), matching: find.byType(Material)),
  );
}
  ...
  return tester
      .widget<Padding>(
        find
            .descendant(
              of: find.ancestor(
                  of: find.byIcon(icon), matching: find.byType(InkResponse)),
