...
void main() {
  ...
  testWidgets('MaterialApp uses darkTheme when themeMode is dark',
      (WidgetTester tester) async {
    addTearDown(tester.platformDispatcher.clearAllTestValues);
  ...
  testWidgets('MaterialApp uses high contrast theme when appropriate',
      (WidgetTester tester) async {
    addTearDown(tester.platformDispatcher.clearAllTestValues);
  ...
  testWidgets('MaterialApp animates theme changes',
      (WidgetTester tester) async {
  ...
  testWidgets('MaterialApp theme animation can be turned off',
      (WidgetTester tester) async {
    final ThemeData lightTheme = ThemeData.light();
    final ThemeData darkTheme = ThemeData.dark();
  ...
  testWidgets('MaterialApp can customize initial routes',
      (WidgetTester tester) async {
  ...
  testWidgets('MaterialApp.navigatorKey can be updated',
      (WidgetTester tester) async {
  ...
  testWidgets('MaterialApp has correct default ScrollBehavior',
      (WidgetTester tester) async {
  ...
  testWidgets('A ScrollBehavior can be set for MaterialApp',
      (WidgetTester tester) async {
    late BuildContext capturedContext;
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Overscroll indicator can be set by theme',
      (WidgetTester tester) async {
    await tester.pumpWidget(MaterialApp(
  ...
  testWidgets('Override theme animation using AnimationStyle',
      (WidgetTester tester) async {
    final ThemeData lightTheme = ThemeData.light();
    final ThemeData darkTheme = ThemeData.dark();
    ...
    await tester.pump(const Duration(
        milliseconds: 50)); // Advance animation by 50 milliseconds.

    // Scaffold background color is slightly updated.
    expect(tester.widget<Material>(find.byType(Material)).color,
        const Color(0xffc3bdc5));
    ...
    await tester
        .pumpWidget(buildWidget(animationStyle: AnimationStyle.noAnimation));
    await tester.pump();
  ...
  testWidgets('MaterialApp works in an unconstrained environment',
      (WidgetTester tester) async {
    await tester.pumpWidget(
