...
void main() {
  ...
  testWidgets('Material3 - AppBar drawer icon has default color',
      (WidgetTester tester) async {
    ...
    expect(_iconStyle(tester, Icons.menu)?.color,
  ...
  testWidgets('AppBar drawer icon is colored by iconTheme',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - AppBar endDrawer icon has default color',
      (WidgetTester tester) async {
    final ThemeData themeData = ThemeData.from(
      colorScheme: const ColorScheme.light(),
      useMaterial3: true,
  ...
  testWidgets('AppBar endDrawer icon is colored by iconTheme',
      (WidgetTester tester) async {
    final ThemeData themeData =
        ThemeData.from(colorScheme: const ColorScheme.light());
    const Color color = Color(0xFF2196F3);
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        home: Scaffold(
          ...
          drawer:
              const Column(), // Doesn't really matter. Triggers a hamburger regardless.
        ),
      ),
    );
  ...
  testWidgets('Material3 - Action is 4dp from edge and 48dp min',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Material3 - AppBar uses the specified elevation or defaults to 0',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - scrolledUnderElevation with nested scroll view',
      (WidgetTester tester) async {
  ...
  testWidgets('AppBar.title sees the correct padding from MediaQuery',
      (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      Localizations(
        ...
        child: Directionality(
          ...
          child: MediaQuery(
            data: const MediaQueryData(
                padding: EdgeInsets.fromLTRB(12, 34, 56, 78)),
            child: Scaffold(
              appBar: AppBar(
  ...
  testWidgets('Material3 - AppBar ink splash draw on the correct canvas',
      (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(
        ...
        theme: ThemeData(
            useMaterial3: true, splashFactory: InkSplash.splashFactory),
        home: Center(
          child: AppBar(
  ...
  testWidgets(
      'Material3 - AppBar draws a light system bar for a dark background',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'Material3 - AppBar draws a dark system bar for a light background',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Default status bar color',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        key: GlobalKey(),
  ...
  group(
      'Material3 - Icons are colored correctly by IconTheme and ActionIconTheme',
      () {
    ...
    testWidgets(
        'Material3 - Action icons and IconButtons are colored by ActionIconTheme',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
        useMaterial3: true,
    ...
    testWidgets(
      ...
      const IconThemeData overallIconTheme =
          IconThemeData(color: Colors.yellow, size: 30.0);
      await tester.pumpWidget(
        MaterialApp(
          theme: themeData,
          home: Scaffold(
      ...
      double? leadingIconButtonSize() =>
          _iconStyle(tester, Icons.menu)?.fontSize;
      Color? actionIconButtonColor() => _iconStyle(tester, Icons.add)?.color;
      double? actionIconButtonSize() =>
          _iconStyle(tester, Icons.menu)?.fontSize;
    ...
    testWidgets(
      ...
      Color? leadingIconButtonColor() =>
          _iconStyle(tester, Icons.arrow_back)?.color;
      double? leadingIconButtonSize() =>
          _iconStyle(tester, Icons.arrow_back)?.fontSize;
    ...
    testWidgets(
      ...
      const IconThemeData actionsIconTheme =
          IconThemeData(color: Colors.yellow, size: 30.0);
      await tester.pumpWidget(
        MaterialApp(
          theme: themeData,
    ...
    testWidgets(
        'Material3 - AppBar.iconTheme is correctly applied in dark mode',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData(
        colorScheme:
            const ColorScheme.dark().copyWith(onSurfaceVariant: Colors.red),
        useMaterial3: true,
      );
      await tester.pumpWidget(
        MaterialApp(
    ...
    // This is a regression test for https://github.com/flutter/flutter/issues/130485.
    testWidgets(
        'Material3 - AppBar.foregroundColor is correctly applied in dark mode',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData(
        colorScheme:
            const ColorScheme.dark().copyWith(onSurfaceVariant: Colors.red),
    ...
    // This is a regression test for https://github.com/flutter/flutter/issues/130485.
    testWidgets(
        'Material3 - AppBar.iconTheme is correctly applied in light mode',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData(
        colorScheme:
            const ColorScheme.light().copyWith(onSurfaceVariant: Colors.red),
        useMaterial3: true,
      );
      await tester.pumpWidget(
        MaterialApp(
    ...
    // This is a regression test for https://github.com/flutter/flutter/issues/130485.
    testWidgets(
        'Material3 - AppBar.foregroundColor is correctly applied in light mode',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData(
        colorScheme:
            const ColorScheme.light().copyWith(onSurfaceVariant: Colors.red),
  ...
  group('MaterialStateColor scrolledUnder', () {
    ...
    testWidgets('backgroundColor for horizontal scrolling',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        home: Scaffold(
          appBar: AppBar(
  ...
  testWidgets(
      'AppBar title with actions should have the same position regardless of centerTitle',
      (WidgetTester tester) async {
    final Key titleKey = UniqueKey();
    bool centerTitle = false;
  ...
  testWidgets('AppBar leading widget can take up arbitrary space',
      (WidgetTester tester) async {
    final Key leadingKey = UniqueKey();
    final Key titleKey = UniqueKey();
  ...
  group('AppBar.forceMaterialTransparency', () {
    ...
    testWidgets(
        'forceMaterialTransparency == true allows gestures beneath the app bar',
        (WidgetTester tester) async {
  ...
  group('Material 2', () {
    testWidgets(
        'Material2 - AppBar draws a light system bar for a dark background',
        (WidgetTester tester) async {
    ...
    testWidgets('Material2 - AppBar drawer icon has default color',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
        useMaterial3: false,
    ...
    testWidgets('Material2 - AppBar endDrawer icon has default color',
        (WidgetTester tester) async {
      final ThemeData themeData = ThemeData.from(
        colorScheme: const ColorScheme.light(),
        useMaterial3: false,
    ...
    testWidgets('Material2 - Action is 4dp from edge and 48dp min',
        (WidgetTester tester) async {
      final ThemeData theme = ThemeData(
        platform: TargetPlatform.android,
        useMaterial3: false,
    ...
    testWidgets(
        'Material2 - AppBar uses the specified elevation or defaults to 4.0',
        (WidgetTester tester) async {
      Widget buildAppBar([double? elevation]) {
        return MaterialApp(
    ...
    testWidgets('Material2 - AppBar ink splash draw on the correct canvas',
      ...
      await tester.pumpWidget(
        MaterialApp(
          // Test was designed against InkSplash so need to make sure that is used.
          theme: ThemeData(
              useMaterial3: false, splashFactory: InkSplash.splashFactory),
          home: Center(
            child: AppBar(
              title: const Text('Abc'),
              actions: <Widget>[
    ...
    testWidgets('Material2 - Default status bar color',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          key: GlobalKey(),
    ...
    testWidgets(
        'Material2 - AppBar draws a dark system bar for a light background',
        (WidgetTester tester) async {
      final ThemeData lightTheme =
          ThemeData(primarySwatch: Colors.lightBlue, useMaterial3: false);
      await tester.pumpWidget(
        MaterialApp(
          theme: lightTheme,
          home: Scaffold(
    ...
    testWidgets(
      ...
      {
        await tester
            .pumpWidget(buildAppBar(ThemeData.dark(useMaterial3: false)));
        final Material appBarMaterial = tester.widget<Material>(
          find.descendant(
            of: find.byType(AppBar),
            matching: find.byType(Material),
