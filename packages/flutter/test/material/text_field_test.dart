...
void main() {
  ...
  const String kThreeLines = 'First line of text is\n'
      ...
      'Third line of stuff';
  const String kMoreThanFourLines = '$kThreeLines\n'
  ...
  testWidgets('Composing change does not hide selection handle caret',
      (WidgetTester tester) async {
    ...
    final RenderObject handleRenderObjectBegin =
        tester.renderObject(fadeFinder.at(0));
    ...
    expect(
      ...
      const TextEditingValue(
        ...
        selection: TextSelection.collapsed(
            offset: 15, affinity: TextAffinity.upstream),
      ),
    );
    ...
    tester.testTextInput.updateEditingValue(
      controller.value.copyWith(
        selection: controller.value.selection
            .copyWith(affinity: TextAffinity.downstream),
    ...
    final RenderObject handleRenderObjectEnd =
        tester.renderObject(fadeFinder.at(0));
    ...
    (WidgetTester tester) async {
      ...
      expect(
          ...
          const TextSelection.collapsed(
              offset: 11, affinity: TextAffinity.upstream));
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final bool isTargetPlatformiOS =
      ...
      expect(find.text('Look Up'),
          isTargetPlatformiOS ? findsOneWidget : findsNothing);
  ...
  testWidgets('sets cursorOpacityAnimates on EditableText correctly',
      (WidgetTester tester) async {
    // True
  ...
  testWidgets('RenderEditable sets correct text editing value',
      (WidgetTester tester) async {
    final TextEditingController controller =
        _textEditingController(text: 'how are you');
  ...
  testWidgets('clipBehavior has expected defaults',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(
        child: const TextField(),
  ...
  testWidgets('Overflow clipBehavior none golden', (WidgetTester tester) async {
    final OverflowWidgetTextEditingController controller =
  ...
  testWidgets('TextInputFormatter gets correct selection value',
      (WidgetTester tester) async {
    ...
    final FocusNode focusNode = _focusNode();
    final TextEditingController controller =
        _textEditingController(text: '123');
    await tester.pumpWidget(
      boilerplate(
        child: TextField(
          controller: controller,
    ...
    expect(
      ...
      const TextEditingValue(
        text: '123',
        selection:
            TextSelection.collapsed(offset: 3, affinity: TextAffinity.upstream),
      ),
    );
    expect(
      actualNewValue,
  ...
  testWidgets('text selection style 1', (WidgetTester tester) async {
    ...
    final Offset textfieldStart =
        tester.getTopLeft(find.byKey(const Key('field0')));
  ...
  testWidgets('Overflowing a line with spaces stops the cursor at the end',
    ...
    const String testValueTwoLines =
        'enough text to overflow the first line and go to the second';
  ...
  testWidgets('desktop obscureText control test', (WidgetTester tester) async {
    ...
    final String editText =
        (findRenderEditable(tester).text! as TextSpan).text!;
    expect(editText.substring(editText.length - 1), '\u2022');
  },
      variant: const TargetPlatformVariant(<TargetPlatform>{
        TargetPlatform.macOS,
  ...
  testWidgets('enableInteractiveSelection = false, tap',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets("Slight movements in longpress don't hide/show handles",
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('infinite multi-line text hint text is not ellipsized by default',
      (WidgetTester tester) async {
    const String kLongString = 'Enter your email Enter your email Enter your '
    ...
    final RenderParagraph paragraph =
        tester.renderObject<RenderParagraph>(find.text(kLongString));
  ...
  testWidgets('non-infinite multi-line hint text is  ellipsized by default',
    ...
    final RenderParagraph paragraph =
        tester.renderObject<RenderParagraph>(find.text(kLongString));
    expect(
        paragraph.size.height < defaultLineHeight * 2 + precisionErrorTolerance,
        isTrue);
  });

  testWidgets('Entering text hides selection handle caret',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets(
      'multiple text fields with prefix and suffix have correct semantics order.',
      (WidgetTester tester) async {
  ...
  testWidgets('selection handles are excluded from the semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('Mouse long press is just like a tap',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('Read only text field basic', (WidgetTester tester) async {
    final TextEditingController controller =
        _textEditingController(text: 'readonly');
    ...
    expect(find.text('Copy'),
        isContextMenuProvidedByPlatform ? findsNothing : findsOneWidget);
    expect(find.text('Paste'), findsNothing);
    expect(find.text('Cut'), findsNothing);
  });

  testWidgets('does not paint toolbar when no options available',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgets('text field build empty toolbar when no options available',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
  ...
  testWidgets('Swapping controllers should update selection',
      (WidgetTester tester) async {
  ...
  testWidgets('enableInteractiveSelection = false, long-press',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets(
    'Selection updates on tap up (Mobile platforms)',
    (WidgetTester tester) async {
      final TextEditingController controller = _textEditingController();
      final bool isTargetPlatformApple =
          defaultTargetPlatform == TargetPlatform.iOS;
  ...
  testWidgets('Can select text by dragging with a mouse',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.dragFrom(textFieldRect.centerRight - const Offset(0.1, 0.0),
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.dragFrom(
          tester.getRect(find.byType(TextField)).centerRight -
  ...
  testWidgets(
    ...
    variant: const TargetPlatformVariant(
        <TargetPlatform>{TargetPlatform.android, TargetPlatform.fuchsia}),
  );
  ...
  testWidgets('Continuous dragging does not cause flickering',
      (WidgetTester tester) async {
    int selectionChangedCount = 0;
    const String testValue = 'abc def ghi';
    final TextEditingController controller =
        _textEditingController(text: testValue);
    ...
    // Drag from 'c' to 'g'.
    final TestGesture gesture =
        await tester.startGesture(cPos, kind: PointerDeviceKind.mouse);
    await tester.pump();
    await gesture.moveTo(gPos);
    await tester.pumpAndSettle();
  ...
  testWidgets('Dragging in opposite direction also works',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
    ...
    final TestGesture gesture =
        await tester.startGesture(gPos, kind: PointerDeviceKind.mouse);
    await tester.pump();
  ...
  testWidgets('Slow mouse dragging also selects text',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('Dragging a collapsed handle should trigger feedback.',
      (WidgetTester tester) async {
    final FeedbackTester feedback = FeedbackTester();
    addTearDown(feedback.dispose);
    final TextEditingController controller = _textEditingController();
    ...
    // of the handle.
    final Offset handlePos = endpoints[0].point + const Offset(1.0, 1.0);
    final Offset newHandlePos =
        textOffsetToPosition(tester, testValue.indexOf('g'));
    gesture = await tester.startGesture(handlePos, pointer: 7);
    await tester.pump();
    await gesture.moveTo(newHandlePos);
    await tester.pump();
  ...
  testWidgets('Cannot drag one handle past the other',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
    ...
    Offset newHandlePos =
        textOffsetToPosition(tester, 5); // Position before 'e'.
    gesture = await tester.startGesture(handlePos, pointer: 7);
    await tester.pump();
    await gesture.moveTo(newHandlePos);
    await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset pos =
          textOffsetToPosition(tester, controller.text.indexOf('v'));
      // The first tap.
      ...
      Offset newHandlePos =
          textOffsetToPosition(tester, 27) + endHandleAdjustment;
      await tester.pump();
      gesture = await tester.startGesture(handlePos, pointer: 7);
      await tester.pump();
      await gesture.moveTo(newHandlePos);
    ...
    variant:
        const TargetPlatformVariant(<TargetPlatform>{TargetPlatform.android}),
  );
  ...
  testWidgets("dragging caret within a word doesn't affect composing region",
      (WidgetTester tester) async {
    const String testValue = 'abc def ghi';
    final TextEditingController controller = TextEditingController.fromValue(
      const TextEditingValue(
  ...
  Future<void> showSelectionMenuAt(
      WidgetTester tester, TextEditingController controller, int index) async {
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset firstLineToolbarTopLeft =
          tester.getTopLeft(find.text('Select all'));
      final Offset firstLineTopLeft =
          textOffsetToPosition(tester, testValue.indexOf('a'));
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset penultimateLineToolbarTopLeft =
          tester.getTopLeft(find.text('Select all'));
      final Offset penultimateLineTopLeft =
          textOffsetToPosition(tester, testValue.indexOf('p'));
      expect(penultimateLineToolbarTopLeft.dy,
          lessThan(penultimateLineTopLeft.dy));
      expect(penultimateLineToolbarTopLeft.dy,
          lessThan(firstLineToolbarTopLeft.dy));
      ...
      expect(find.text('Select all'), findsOneWidget);
      final Offset lastLineToolbarTopLeft =
          tester.getTopLeft(find.text('Select all'));
      final Offset lastLineTopLeft =
          textOffsetToPosition(tester, testValue.indexOf('p'));
      expect(lastLineToolbarTopLeft.dy, lessThan(lastLineTopLeft.dy));
      expect(lastLineToolbarTopLeft.dy,
          greaterThan(penultimateLineToolbarTopLeft.dy));
    },
    skip:
        isContextMenuProvidedByPlatform, // [intended] only applies to platforms where we supply the context menu.
  );
  ...
  testWidgets('An obscured TextField is selectable by default',
      (WidgetTester tester) async {
    // This is a regression test for
  ...
  testWidgets('An obscured TextField is not selectable when disabled',
      (WidgetTester tester) async {
    // This is a regression test for
    // https://github.com/flutter/flutter/issues/32845
  ...
  testWidgets('An obscured TextField is selected as one word',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('An obscured TextField has correct default context menu',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('TextField height with minLines unset',
      (WidgetTester tester) async {
  ...
  testWidgets('TextField height with minLines and maxLines',
      (WidgetTester tester) async {
    await tester.pumpWidget(textFieldBuilder());
  ...
  testWidgets('Multiline text when wrapped in Expanded',
      (WidgetTester tester) async {
    ...
    await tester
        .pumpWidget(expandedTextFieldBuilder(expands: true, maxLines: null));
    ...
    expect(() async {
      await tester
          .pumpWidget(expandedTextFieldBuilder(expands: true, maxLines: 4));
    }, throwsAssertionError);
    expect(() async {
      await tester.pumpWidget(
          expandedTextFieldBuilder(expands: true, minLines: 1, maxLines: null));
    }, throwsAssertionError);
  });

  // Regression test for https://github.com/flutter/flutter/pull/29093
  testWidgets('Multiline text when wrapped in IntrinsicHeight',
      (WidgetTester tester) async {
  ...
  testWidgets('Growable TextField when content height exceeds parent',
      (WidgetTester tester) async {
    ...
    expect(
        inputBox.size.height, height - padding - helperTextSpace - subtextGap);
    ...
    expect(
      ...
      height - padding - labelSpace - counterSpace,
    );
  });
  ...
  testWidgets('Multiline hint text will wrap up to maxLines',
    ...
    expect(findHintText(multipleLineText).size.width,
        greaterThanOrEqualTo(oneLineHintSize.width));
    expect(findHintText(multipleLineText).size.height,
  ...
  testWidgets('Can drag handles to change selection in multiline',
    ...
    final Offset firstPos =
        textOffsetToPosition(tester, testValue.indexOf('First'));
    final Offset secondPos =
        textOffsetToPosition(tester, testValue.indexOf('Second'));
    final Offset thirdPos =
        textOffsetToPosition(tester, testValue.indexOf('Third'));
    final Offset middleStringPos =
        textOffsetToPosition(tester, testValue.indexOf('irst'));
    ...
    final Offset untilPos =
        textOffsetToPosition(tester, testValue.indexOf('until') + 1);
    ...
    Offset newHandlePos =
        textOffsetToPosition(tester, testValue.indexOf('Third') + 5) +
            downLineOffset;
    gesture = await tester.startGesture(handlePos, pointer: 7);
    await tester.pump();
    await gesture.moveTo(newHandlePos);
  ...
  testWidgets('Can scroll multiline input', (WidgetTester tester) async {
    ...
    final Offset firstPos =
        textOffsetToPosition(tester, kMoreThanFourLines.indexOf('First'));
    final Offset fourthPos =
        textOffsetToPosition(tester, kMoreThanFourLines.indexOf('Fourth'));
    expect(firstPos.dx, fourthPos.dx);
    expect(firstPos.dy, lessThan(fourthPos.dy));
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(firstPos)),
        isTrue);
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(fourthPos)),
        isFalse);
    ...
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(newFirstPos)),
        isFalse);
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(newFourthPos)),
        isTrue);
    ...
    final Offset newHandlePos =
        textOffsetToPosition(tester, kMoreThanFourLines.indexOf('First') + 5);
    gesture = await tester.startGesture(handlePos, pointer: 7);
    await tester.pump(const Duration(seconds: 1));
  ...
  testWidgets('TextField errorText trumps helperText',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Theme(
        data: ThemeData(useMaterial3: false),
  ...
  testWidgets('TextField with default helperStyle',
      (WidgetTester tester) async {
    final ThemeData themeData =
        ThemeData(hintColor: Colors.blue[500], useMaterial3: false);
    await tester.pumpWidget(
      overlay(
        child: Theme(
          data: themeData,
    ...
    expect(helperText.style!.fontSize,
        Typography.englishLike2014.bodySmall!.fontSize);
  });

  testWidgets('TextField with specified helperStyle',
      (WidgetTester tester) async {
  ...
  testWidgets('Material2 - TextField with default hintStyle',
      (WidgetTester tester) async {
    final TextStyle style = TextStyle(
      color: Colors.pink[500],
      fontSize: 10.0,
  ...
  testWidgets('TextField with specified hintStyle',
      (WidgetTester tester) async {
  ...
  testWidgets('TextField with specified prefixStyle',
      (WidgetTester tester) async {
  ...
  testWidgets('TextField prefix and suffix create a sibling node',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    await tester.pumpWidget(
      overlay(
  ...
  testWidgets('TextField with specified suffixStyle',
      (WidgetTester tester) async {
  ...
  testWidgets(
      'TextField prefix and suffix appear correctly with no hint or label',
      (WidgetTester tester) async {
  ...
  testWidgets('Icon is separated from input/label by 16+12',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      overlay(
        child: const TextField(
    ...
    expect(iconRight + 28.0,
        equals(tester.getTopLeft(find.byType(EditableText)).dx));
  });
  ...
  testWidgets('Collapsed hint text placement', (WidgetTester tester) async {
    ...
    expect(tester.getTopLeft(find.text('hint')),
  ...
  testWidgets('Cannot enter new lines onto single line TextField',
      (WidgetTester tester) async {
  ...
  testWidgets('Injected formatters are chained (deprecated names)',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
  ...
  testWidgets('Chained formatters are in sequence',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
  ...
  testWidgets('Chained formatters are in sequence (deprecated names)',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
  ...
  testWidgets('Pasted values are formatted (deprecated names)',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
  ...
  testWidgets('Text field scrolls the caret into view',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('Multiline text field scrolls the caret into view',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
    ...
    expect(scrollableState.position.pixels,
        moreOrLessEquals(lineHeight, epsilon: 0.1));
  });
  ...
  testWidgets('Text field drops selection color when losing focus',
      (WidgetTester tester) async {
  ...
  testWidgets('Selection is consistent with text length',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('maxLength limits input with surrogate pairs.',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
    ...
    await tester.enterText(
        find.byType(TextField), '${surrogatePair}0123456789101112');
    expect(textController.text, '${surrogatePair}012345678');
  });

  testWidgets('maxLength limits input with grapheme clusters.',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
    ...
    await tester.enterText(
        find.byType(TextField), '${graphemeCluster}0123456789101112');
  ...
  testWidgets('maxLength still works with other formatters',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
  ...
  testWidgets('maxLength shows warning when maxLengthEnforcement.none.',
    ...
    expect(
        counterTextWidget.style!.color, isNot(equals(Colors.deepPurpleAccent)));
  });

  testWidgets('maxLength shows warning in Material 3',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
    final ThemeData theme = ThemeData.from(
      colorScheme:
          const ColorScheme.light().copyWith(error: Colors.deepPurpleAccent),
      useMaterial3: true,
    );
    await tester.pumpWidget(boilerplate(
      theme: theme,
  ...
  testWidgets(
      'maxLength shows warning when maxLengthEnforcement.none with surrogate pairs.',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
    const TextStyle testStyle = TextStyle(color: Colors.deepPurpleAccent);
  ...
  testWidgets(
      'maxLength shows warning when maxLengthEnforcement.none with grapheme clusters.',
      (WidgetTester tester) async {
    final TextEditingController textController = _textEditingController();
    const TextStyle testStyle = TextStyle(color: Colors.deepPurpleAccent);
  ...
  testWidgets('TextField identifies as text field in semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Can scroll multiline input when disabled',
      (WidgetTester tester) async {
    final Key textFieldKey = UniqueKey();
    final TextEditingController controller = _textEditingController(
      text: kMoreThanFourLines,
    ...
    // Now the first line is scrolled up, and the fourth line is visible.
    final Offset finalFirstPos =
        textOffsetToPosition(tester, kMoreThanFourLines.indexOf('First'));
    final Offset finalFourthPos =
        textOffsetToPosition(tester, kMoreThanFourLines.indexOf('Fourth'));

    expect(finalFirstPos.dy, lessThan(firstPos.dy));
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(finalFirstPos)),
        isFalse);
    expect(
        inputBox.hitTest(BoxHitTestResult(),
            position: inputBox.globalToLocal(finalFourthPos)),
        isTrue);
  });

  testWidgets('Disabled text field does not have tap action',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    await tester.pumpWidget(
      const MaterialApp(
    ...
    expect(
        semantics,
        isNot(includesNodeWith(actions: <SemanticsAction>[
          SemanticsAction.tap,
  ...
  testWidgets('Disabled text field semantics node still contains value',
    ...
    expect(semantics,
        includesNodeWith(actions: <SemanticsAction>[], value: 'text'));
    semantics.dispose();
  });

  testWidgets('Readonly text field does not have tap action',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
  ...
  testWidgets('Disabled text field hides helper and counter',
      (WidgetTester tester) async {
  ...
  testWidgets(
    ...
    expect(
        ...
        Colors
            .black38); // Colors.black38 is the default disabled color for ThemeData.light().
  });
  ...
  testWidgets(
    ...
    final EditableText editableText = tester.widget(find.byType(EditableText));
    expect(editableText.style.color,
        theme.textTheme.bodyLarge!.color!.withOpacity(0.38));
  });

  testWidgets('Enabled TextField statesController',
      (WidgetTester tester) async {
    ...
    await gesture.up();
    await tester.pump();
    expect(statesController.value,
        <MaterialState>{MaterialState.hovered, MaterialState.focused});
    ...
    await tester.pumpAndSettle();
    expect(statesController.value,
        <MaterialState>{MaterialState.hovered, MaterialState.disabled});
  ...
  testWidgets('Disabled TextField statesController',
      (WidgetTester tester) async {
    int count = 0;
    void valueChanged() {
      count += 1;
  ...
  testWidgets('Provided style correctly resolves for material states',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('currentValueLength/maxValueLength are in the tree',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets("Disabled TextField can't be traversed to.",
      (WidgetTester tester) async {
  ...
  group('Keyboard Tests', () {
    ...
    testWidgets('Read only keyboard selection test',
        (WidgetTester tester) async {
      final TextEditingController controller =
          _textEditingController(text: 'readonly');
      await tester.pumpWidget(
  ...
  testWidgets('Caret works when maxLines is null', (WidgetTester tester) async {
    ...
    await tester.pump();
    await tester.pump(const Duration(
        milliseconds: 200)); // skip past the frame where the opacity is

    // Confirm that the selection was updated.
    expect(controller.selection.baseOffset, 0);
  });

  testWidgets('TextField baseline alignment no-strut',
      (WidgetTester tester) async {
            ...
            children: <Widget>[
              Expanded(
                child: TextField(
                  ...
                  style: const TextStyle(
                      fontFamily: 'FlutterTest', fontSize: 12.0),
                  strutStyle: StrutStyle.disabled,
                ),
              ),
              const Text(
              ...
              Expanded(
                child: TextField(
                  ...
                  // https://github.com/flutter/flutter/issues/122066 is resolved.
                  style: const TextStyle(
                      fontFamily: 'FlutterTest', fontSize: 36.0),
                  strutStyle: StrutStyle.disabled,
                ),
              ),
            ],
  ...
  testWidgets('Update textField semantics when obscureText changes',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final TextEditingController controller = _textEditingController();
  ...
  testWidgets('TextField semantics for selections',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final TextEditingController controller = _textEditingController()
      ..text = 'Hello';
  ...
  testWidgets('TextField change selection with semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final SemanticsOwner semanticsOwner =
        tester.binding.pipelineOwner.semanticsOwner;
  ...
  testWidgets('When clipboard empty, no semantics paste option',
      (WidgetTester tester) async {
    const String textInTextField = 'Hello';
  ...
  testWidgets('TextField loses focus when disabled',
      (WidgetTester tester) async {
  ...
  testWidgets('TextField displays text with text direction',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
  ...
  testWidgets('InputDecoration errorText semantics',
      (WidgetTester tester) async {
    final SemanticsTester semantics = SemanticsTester(tester);
    final TextEditingController controller = _textEditingController();
    final Key key = UniqueKey();
  ...
  testWidgets(
      ...
      (WidgetTester tester) async {
    final TextEditingController controller =
        _textEditingController(text: 'Just some text');
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: false),
        home: Scaffold(
  ...
  testWidgets(
    ...
    await tester.pumpAndSettle();
    await tester.enterText(
        find.byKey(textField2), '2'); //scroll textField2 into view
    await tester.pumpAndSettle();
    await tester.enterText(
        find.byKey(textField1), '3'); //scroll textField1 back into view
    await tester.pumpAndSettle();
  ...
  testWidgets('TextField scrolls into view but does not bounce (ListView)',
          ...
          body: SafeArea(
            child: ListView(
              ...
              children: <Widget>[
                ...
                const SizedBox(
                  height:
                      450.0, // 50.0 smaller than the overall frame so that both
    ...
    await tester.pumpWidget(buildFrame(Axis.vertical));
    await tester.enterText(
        find.byKey(textField1), '1'); // textfield1 is visible
    await tester.pumpAndSettle();
    await tester.enterText(
        find.byKey(textField2), '2'); //scroll textField2 into view
    await tester.pumpAndSettle();
  ...
  testWidgets('TextField style is merged with theme',
      (WidgetTester tester) async {
    ...
    expect(editableText.style.background,
        themeData.textTheme.titleMedium!.background);
    expect(
        editableText.style.shadows, themeData.textTheme.titleMedium!.shadows);
    expect(editableText.style.decoration,
        themeData.textTheme.titleMedium!.decoration);
    expect(editableText.style.locale, themeData.textTheme.titleMedium!.locale);
    expect(editableText.style.wordSpacing,
        themeData.textTheme.titleMedium!.wordSpacing);
  ...
  testWidgets('TextField style is merged with theme in Material 3',
      (WidgetTester tester) async {
    // Regression test for https://github.com/flutter/flutter/issues/23994
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const Color expectedSelectionHandleColor =
          Color.fromARGB(255, 10, 200, 255);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection.collapsed(
            offset: 7, affinity: TextAffinity.upstream),
      );
  ...
  testWidgets('tap moves cursor to the position tapped',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset pos =
          textOffsetToPosition(tester, 6); // Index of 'Atwate|r'.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset endPos = textOffsetToPosition(tester, 35) +
          const Offset(200.0,
              0.0); // Index of 'Bonaventure|' + Offset(200.0,0), which is at the end of the first line.
      final Offset vPos =
          textOffsetToPosition(tester, 29); // Index of 'Bonav|enture'.
      final Offset wPos =
          textOffsetToPosition(tester, 3); // Index of 'Atw|ater'.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset vPos =
          textOffsetToPosition(tester, 29); // Index of 'Bonav|enture'.
      final Offset ePos = textOffsetToPosition(tester, 35) +
          const Offset(7.0,
              0.0); // Index of 'Bonaventure|' + Offset(7.0,0), which taps slightly to the right of the end of the text.
      final Offset wPos =
          textOffsetToPosition(tester, 3); // Index of 'Atw|ater'.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection.collapsed(
            offset: 12, affinity: TextAffinity.upstream),
      );
      await tester.tapAt(pPos);
      await tester.pumpAndSettle();
  ...
  testWidgets('iOS selectWordEdge works correctly',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'blah1 blah2',
    );
  ...
  group('Triple tap/click', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
            controller.selection.extentOffset, isTargetPlatformApple ? 6 : 7);
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final TestGesture gesture = await tester.startGesture(thirdLinePos,
            kind: PointerDeviceKind.mouse);
        await tester.pump();
        await gesture.up();
        await tester.pump();
      ...
      variant: TargetPlatformVariant.all(
          excluding: <TargetPlatform>{TargetPlatform.linux}),
    );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        // Click on text field to gain focus, and move the selection.
        final TestGesture gesture = await tester.startGesture(endOfTextPos,
            kind: PointerDeviceKind.mouse);
        await tester.pump();
        await gesture.up();
        await tester.pump();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
          controller.selection,
          const TextSelection.collapsed(
              offset: 50, affinity: TextAffinity.upstream),
        );
        expectNoCupertinoToolbar();
        // Second tap selects the word.
        await tester.tapAt(textfieldStart + const Offset(150.0, 50.0));
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final Offset textFieldStart = tester.getTopLeft(find.byType(TextField));
        final bool platformSelectsByLine =
        ...
        expect(
          controller.selection,
          TextSelection(
              baseOffset: 0, extentOffset: platformSelectsByLine ? 19 : 20),
        );
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        final double lineHeight =
            findRenderEditable(tester).preferredLineHeight;
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final bool targetPlatformIsiOS =
          defaultTargetPlatform == TargetPlatform.iOS;
      ...
      expect(
        ...
        isContextMenuProvidedByPlatform
            ? findsNothing
            : findsNWidgets(numberOfContextMenuButtons),
      );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture =
          await tester.startGesture(tester.getBottomLeft(find.byKey(key1)));
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final TestGesture gesture =
          await tester.startGesture(textOffsetToPosition(tester, 0));
      await tester.pump();
      await gesture.up();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final bool isTargetPlatformMobile =
          defaultTargetPlatform == TargetPlatform.iOS;
      final Offset secondTapPos =
          isTargetPlatformMobile ? ePos : ePos + const Offset(-1.0, 0.0);
  ...
  testWidgets('long press drag can edge scroll on non-Apple platforms',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text:
    ...
    List<TextSelectionPoint> lastCharEndpoint =
    ...
    expect(
      controller.selection,
      const TextSelection(
          baseOffset: 0, extentOffset: 7, affinity: TextAffinity.upstream),
    );
    expectNoMaterialToolbar();
    ...
    expect(
      controller.selection,
      const TextSelection(
          baseOffset: 0, extentOffset: 66, affinity: TextAffinity.upstream),
    ...
    final List<TextSelectionPoint> firstCharEndpoint =
        renderEditable.getEndpointsForSelection(
  ...
  testWidgets(
    ...
    expect(
      controller.selection,
      const TextSelection.collapsed(
          offset: 66, affinity: TextAffinity.upstream),
    ); // We're at the edge now.
    expectNoCupertinoToolbar();
  ...
  testWidgets('mouse click and drag can edge scroll',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text:
          'Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges',
    ...
    final Size screenSize =
        MediaQuery.of(tester.element(find.byType(TextField))).size;
    // Just testing the test and making sure that the last character is off
    // the right side of the screen.
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // The first character is now offscreen to the left.
      expect(textOffsetToPosition(tester, 0).dx,
          moreOrLessEquals(-257.0, epsilon: 1));
    },
    variant: TargetPlatformVariant.all(),
    skip: isBrowser, // [intended] Browser handles arrow keys differently.
  );

  testWidgets('long press drag can edge scroll vertically',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text:
          'Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neigse Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges',
  ...
  testWidgets('mouse click and drag can edge scroll vertically',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text:
          'Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges',
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // desktop.
      final Offset pPos = textOffsetToPosition(tester, 9) +
          const Offset(0.0, -20.0); // Index of 'P|eel'
      final Offset wPos =
          textOffsetToPosition(tester, 3); // Index of 'Atw|ater'
  ...
  testWidgets('selecting a space selects the space on non-iOS platforms',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: ' blah blah',
    );
    ...
    await tester
        .tapAt(textOffsetToPosition(tester, 10) + const Offset(200.0, 0.0));
    expect(controller.value.selection, isNotNull);
    expect(controller.value.selection.baseOffset, 10);
    expect(controller.value.selection.extentOffset, 10);
  ...
  testWidgets('selecting a space selects the space on Desktop platforms',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: ' blah blah',
    );
  ...
  testWidgets(
    ...
    final Offset offset =
        tester.getTopLeft(find.byType(TextField)) + const Offset(150.0, 9.0);
  ...
  testWidgets('tap on non-force-press-supported devices work',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('TextField implements debugFillProperties',
      (WidgetTester tester) async {
    final DiagnosticPropertiesBuilder builder = DiagnosticPropertiesBuilder();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme:
              ThemeData(platform: TargetPlatform.android, useMaterial3: false),
          home: const Material(
            child: Center(
              child: TextField(
  ...
  testWidgets(
    ...
    skip:
        isBrowser, // TODO(mdebbar): https://github.com/flutter/flutter/issues/32243
  );
  ...
  testWidgets('Caret indexes into trailing whitespace center align',
    ...
    expect(topLeft.dx,
        equals(415)); // Should be same as equivalent in 'Caret center position'

    topLeft = editable.localToGlobal(
      editable.getLocalRectForCaret(const TextPosition(offset: 2)).topLeft,
    );
    expect(topLeft.dx,
        equals(399)); // Should be same as equivalent in 'Caret center position'

    topLeft = editable.localToGlobal(
      editable.getLocalRectForCaret(const TextPosition(offset: 1)).topLeft,
    );
    expect(topLeft.dx,
        equals(383)); // Should be same as equivalent in 'Caret center position'
  });
  ...
  testWidgets('iOS selection handles are rendered and not faded away',
      (WidgetTester tester) async {
    const String testText = 'lorem ipsum';
    final TextEditingController controller =
        _textEditingController(text: testText);
  ...
  testWidgets('Long press shows handles and toolbar',
    ...
    final EditableTextState editableText =
        tester.state(find.byType(EditableText));
    expect(editableText.selectionOverlay!.handlesAreVisible, isTrue);
    expect(editableText.selectionOverlay!.toolbarIsVisible,
  ...
  testWidgets('Tapping selection handles toggles the toolbar',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'abc def ghi',
    );
  ...
  group('height', () {
    ...
    testWidgets(
        'When isDense, TextField can go below kMinInteractiveDimension height',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(),
        home: const Scaffold(
    ...
    group('intrinsics', () {
      ...
      testWidgets(
          'By default, intrinsic height is at least kMinInteractiveDimension high',
          (WidgetTester tester) async {
  ...
  testWidgets('Scrolling shortcuts are disabled in text fields',
      (WidgetTester tester) async {
  ...
  testWidgets('TextField changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
    ...
    final Offset edge =
        tester.getTopLeft(find.byType(TextField)) + const Offset(1, 1);
  ...
  testWidgets('TextField icons change mouse cursor when hovered',
      (WidgetTester tester) async {
  ...
  testWidgets('Caret rtl with changing width', (WidgetTester tester) async {
    ...
    const TextStyle style = TextStyle(
        fontSize: 10, height: 1.0, letterSpacing: 0.0, wordSpacing: 0.0);
  ...
  testWidgets(
    ...
    await tester
        .pumpWidget(textFieldBuilder(behavior: FloatingLabelBehavior.never));
    ...
    await tester
        .pumpWidget(textFieldBuilder(behavior: FloatingLabelBehavior.always));
    await tester.pumpAndSettle(); // theme animation.
  ...
  testWidgets(
      'TextFields can inherit errorStyle color from InputDecorationTheme.',
      (WidgetTester tester) async {
    Widget textFieldBuilder() {
      return MaterialApp(
        theme: ThemeData(
  ...
  group('MaxLengthEnforcement', () {
    ...
    testWidgets('using truncateAfterCompositionEnds.',
        (WidgetTester tester) async {
      const MaxLengthEnforcement enforcement =
    ...
    testWidgets('using default behavior for different platforms.',
        (WidgetTester tester) async {
      ...
      state.updateEditingValue(const TextEditingValue(
          text: '侬好啊旁友', composing: TextRange(start: 3, end: 5)));
  ...
  testWidgets('prefix/suffix buttons do not leak touch events',
      (WidgetTester tester) async {
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
          child: Center(
            child: TextField(
              decoration: InputDecoration(hintText: 'placeholder text'),
            ),
          ),
        ),
      ),
  ...
  testWidgets(
      'TextField at rest does not push any layers with alwaysNeedsAddToScene',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(
        home: Material(
    ...
    expect(
        tester.layers.any((Layer layer) => layer.debugSubtreeNeedsAddToScene),
        isFalse);
  });

  testWidgets(
      'Focused TextField does not push any layers with alwaysNeedsAddToScene',
      (WidgetTester tester) async {
    final FocusNode focusNode = _focusNode();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('cursor blinking respects TickerMode',
      (WidgetTester tester) async {
    final FocusNode focusNode = _focusNode();
    Widget builder({required bool tickerMode}) {
      return MaterialApp(
        home: Material(
          child: Center(
            child: TickerMode(
                enabled: tickerMode, child: TextField(focusNode: focusNode)),
          ),
        ),
      );
    }
  ...
  testWidgets('can shift + tap to select with a keyboard (Apple platforms)',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('can shift + tap to select with a keyboard (non-Apple platforms)',
      (WidgetTester tester) async {
    final TextEditingController controller = _textEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('Cannot request focus when canRequestFocus is false',
      (WidgetTester tester) async {
    final FocusNode focusNode = _focusNode();
  ...
  group('Right click focus', () {
    testWidgets('Can right click to focus multiple times',
        (WidgetTester tester) async {
  ...
  group('context menu', () {
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
            home:
                Material(child: TextField(key: key, controller: controller))));
          ...
          MaterialApp(
            home: Material(
              child: Padding(
                ...
                child: TextField(
                    key: key, controller: controller, contextMenuBuilder: null),
              ),
            ),
          ),
        );
  ...
  group('magnifier builder', () {
    ...
    group('defaults', () {
      testWidgets('should build Magnifier on Android',
          (WidgetTester tester) async {
        await tester
            .pumpWidget(const MaterialApp(home: Scaffold(body: TextField())));

        final BuildContext context =
            tester.firstElement(find.byType(TextField));
        final EditableText editableText =
  ...
  group('magnifier', () {
    ...
    testWidgets('Can drag to show, unshow, and update magnifier',
        (WidgetTester tester) async {
      final TextEditingController controller = _textEditingController();
      await tester.pumpWidget(
        MaterialApp(
    ...
    testWidgets('Can long press to show, unshow, and update magnifier',
        (WidgetTester tester) async {
      final TextEditingController controller = _textEditingController();
      final bool isTargetPlatformAndroid =
          defaultTargetPlatform == TargetPlatform.android;
      await tester.pumpWidget(
        MaterialApp(
          home: Material(
      ...
      final TestGesture gesture = await tester
          .startGesture(textOffsetToPosition(tester, testValue.indexOf('e')));
      await tester.pumpAndSettle(const Duration(milliseconds: 1000));
      expect(controller.selection.baseOffset, isTargetPlatformAndroid ? 4 : 5);
      expect(
          controller.selection.extentOffset, isTargetPlatformAndroid ? 7 : 5);
      expect(find.byKey(fakeMagnifier.key!), findsOneWidget);

      final Offset firstLongPressGesturePosition =
          magnifierInfo.value.globalGesturePosition;
      ...
      await gesture
          .moveTo(textOffsetToPosition(tester, testValue.indexOf('h')));
      await tester.pumpAndSettle();
      expect(controller.selection.baseOffset, isTargetPlatformAndroid ? 4 : 9);
      expect(
          controller.selection.extentOffset, isTargetPlatformAndroid ? 11 : 9);
      expect(find.byKey(fakeMagnifier.key!), findsOneWidget);
      // Expect the position the magnifier gets to have moved.
  ...
  group('TapRegion integration', () {
    testWidgets('Tapping outside loses focus on desktop',
        (WidgetTester tester) async {
    ...
    testWidgets("Tapping outside doesn't lose focus on mobile",
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Test Node');
      addTearDown(focusNode.dispose);
      await tester.pumpWidget(
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        final FocusNode focusNode = FocusNode(debugLabel: 'Test Node');
        final TextEditingController controller =
            _textEditingController(text: 'A B C');
        addTearDown(focusNode.dispose);
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(
                ...
                child: SizedBox(
                  ...
                  child: Opacity(
                    ...
                    child: TextField(
                      ...
                      focusNode: focusNode,
                      decoration:
                          const InputDecoration(hintText: 'Placeholder'),
                    ),
                  ),
                ),
              ),
      ...
      variant: TargetPlatformVariant.all(),
      skip:
          isBrowser, // [intended] On the web, the toolbar isn't rendered by Flutter.
    );

    testWidgets("Tapping on input decorator doesn't lose focus",
        (WidgetTester tester) async {
      final FocusNode focusNode = FocusNode(debugLabel: 'Test Node');
      addTearDown(focusNode.dispose);
      await tester.pumpWidget(
    ...
    for (final PointerDeviceKind pointerDeviceKind
        in PointerDeviceKind.values.toSet()
  ...
  testWidgets(
    ...
    final EditableTextState editableTextState =
        tester.state<EditableTextState>(find.byType(EditableText));
    editableTextState.spellCheckResults = const SpellCheckResults(
      '',
      <SuggestionSpan>[
  ...
  testWidgets(
    ...
    expect(
      editableTextState
          .spellCheckConfiguration.spellCheckSuggestionsToolbarBuilder,
  ...
  testWidgets(
    ...
    skip:
        isContextMenuProvidedByPlatform, // [intended] only applies to platforms where we supply the context menu.
    variant: TargetPlatformVariant.all(
        excluding: TargetPlatformVariant.mobile().values),
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final bool areTextActionsSupported =
          defaultTargetPlatform == TargetPlatform.android;
      expect(find.byType(AdaptiveTextSelectionToolbar), findsOneWidget);
      expect(find.text(fakeAction1Label),
          areTextActionsSupported ? findsOneWidget : findsNothing);
      expect(find.text(fakeAction2Label),
          areTextActionsSupported ? findsOneWidget : findsNothing);
    },
    variant: TargetPlatformVariant.all(),
    skip:
  ...
  testWidgets(
    'Start the floating cursor on long tap',
    (WidgetTester tester) async {
      EditableText.debugDeterministicCursor = true;
      final TextEditingController controller = _textEditingController(
        text: 'abcd',
      ...
      await expectLater(
        find.byKey(const ValueKey<int>(1)),
        matchesGoldenFile(
            'text_field_floating_cursor.regular_and_floating_both.material.0.png'),
      );
      ...
      await expectLater(
        find.byKey(const ValueKey<int>(1)),
        matchesGoldenFile(
            'text_field_floating_cursor.only_floating_cursor.material.0.png'),
      );
      await gesture.up();
      EditableText.debugDeterministicCursor = false;
    },
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      Future<void> checkCursorBlinking({bool isBlinking = true}) async {
        ...
        await tester.pump(state.cursorBlinkInterval);
        expect(state.cursorCurrentlyVisible,
      ...
      final TestGesture gesture =
          await tester.startGesture(tester.getTopLeft(find.byType(TextField)));
      await tester.pump(kLongPressTimeout);
