...
void main() {
  ...
  testWidgets(
      'ElevatedButton.icon produces the correct widgets if icon is null',
      (WidgetTester tester) async {
    const ColorScheme colorScheme = ColorScheme.light();
    final ThemeData theme = ThemeData.from(colorScheme: colorScheme);
    final Key iconButtonKey = UniqueKey();
  ...
  testWidgets(
    ...
    Color textColor() {
      return tester
          .renderObject<RenderParagraph>(find.text('ElevatedButton'))
          .text
          .style!
          .color;
    }
  ...
  testWidgets("ElevatedButton response doesn't hover when disabled",
      (WidgetTester tester) async {
  ...
  testWidgets('Can set ElevatedButton focus and Can set unFocus.',
      (WidgetTester tester) async {
  ...
  testWidgets('Does ElevatedButton work with autofocus',
      (WidgetTester tester) async {
    const Color focusColor = Color(0xff001122);
  ...
  testWidgets('Does ElevatedButton contribute semantics',
      (WidgetTester tester) async {
  ...
  testWidgets('ElevatedButton has no clip by default',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('ElevatedButton.icon responds to applied padding',
      (WidgetTester tester) async {
  ...
  testWidgets('Override ElevatedButton default padding',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData.from(colorScheme: const ColorScheme.light()),
  ...
  testWidgets('M3 ElevatedButton has correct padding',
      (WidgetTester tester) async {
  ...
  testWidgets('M3 ElevatedButton.icon has correct padding',
      (WidgetTester tester) async {
    final Key key = UniqueKey();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Fixed size ElevatedButtons', (WidgetTester tester) async {
        ...
        home: Scaffold(
          body: Column(
            ...
            children: <Widget>[
              ElevatedButton(
                style:
                    ElevatedButton.styleFrom(fixedSize: const Size(100, 100)),
                onPressed: () {},
    ...
    expect(tester.getSize(find.widgetWithText(ElevatedButton, '100x100')),
        const Size(100, 100));
    expect(tester.getSize(find.widgetWithText(ElevatedButton, '200xh')).width,
        200);
    expect(tester.getSize(find.widgetWithText(ElevatedButton, 'wx200')).height,
        200);
  });
  ...
  testWidgets('ElevatedButton.icon does not overflow',
      (WidgetTester tester) async {
  ...
  testWidgets('ElevatedButton.icon icon,label layout',
      (WidgetTester tester) async {
    final Key buttonKey = UniqueKey();
  ...
  testWidgets('Fixed size ElevatedButton, same as minimumSize == maximumSize',
    ...
    expect(tester.getSize(find.widgetWithText(ElevatedButton, '200x200')),
        const Size(200, 200));
    expect(tester.getSize(find.widgetWithText(ElevatedButton, '200,200')),
        const Size(200, 200));
  });

  testWidgets('ElevatedButton changes mouse cursor when hovered',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      Directionality(
        textDirection: TextDirection.ltr,
  ...
  testWidgets('ElevatedButton.icon statesController',
      (WidgetTester tester) async {
    testStatesController(const Icon(Icons.add), tester);
  });

  testWidgets('Disabled ElevatedButton statesController',
      (WidgetTester tester) async {
    int count = 0;
    void valueChanged() {
      count += 1;
  ...
  testWidgets('ElevatedButton foregroundBuilder drops button child',
      (WidgetTester tester) async {
    const Color foregroundColor = Color(0xFF000022);
