...
void main() {
  ...
  testWidgets('Large Badge alignment', (WidgetTester tester) async {
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect:
                  RRect.fromLTRBR(200 - 16, 100, 200, 100 + 16, badgeRadius)));
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(
                  100 - 8, 200, 100 + 8, 200 + 16, badgeRadius)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect:
                  RRect.fromLTRBR(200 - 16, 200, 200, 200 + 16, badgeRadius)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(0, 100, 16, 100 + 16, badgeRadius)
                  .shift(offset)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(200 - 16, 100, 200, 100 + 16, badgeRadius)
                  .shift(offset)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(0, 200, 16, 200 + 16, badgeRadius)
                  .shift(offset)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect:
                  RRect.fromLTRBR(100 - 8, 200, 100 + 8, 200 + 16, badgeRadius)
                      .shift(offset)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(200 - 16, 200, 200, 200 + 16, badgeRadius)
                  .shift(offset)));
  });
  ...
  testWidgets('Small Badge alignment', (WidgetTester tester) async {
    ...
    await tester.pumpWidget(buildFrame(Alignment.centerLeft));
    expect(box,
        paints..rrect(rrect: RRect.fromLTRBR(0, 100, 6, 100 + 6, badgeRadius)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(200 - 6, 100, 200, 100 + 6, badgeRadius)));

    await tester.pumpWidget(buildFrame(Alignment.bottomLeft));
    expect(box,
        paints..rrect(rrect: RRect.fromLTRBR(0, 200, 6, 200 + 6, badgeRadius)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(
                  100 - 3, 200, 100 + 3, 200 + 6, badgeRadius)));
    ...
    expect(
        ...
        paints
          ..rrect(
              rrect: RRect.fromLTRBR(200 - 6, 200, 200, 200 + 6, badgeRadius)));
  ...
  testWidgets('Badge Larger than large size', (WidgetTester tester) async {
    ...
    expect(box,
        paints..rrect(rrect: RRect.fromLTRBR(0, -7, 30 + 8, 23, badgeRadius)));
  });
}
