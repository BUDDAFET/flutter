...
void main() {
  ...
  testWidgets('Drawer dismiss barrier has no label',
  ...
  testWidgets('Scaffold.drawer - null restorationId ',
      (WidgetTester tester) async {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Scaffold.endDrawer - null restorationId ',
      (WidgetTester tester) async {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Scaffold.drawer state restoration test',
      (WidgetTester tester) async {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Scaffold.endDrawer state restoration test',
      (WidgetTester tester) async {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Both drawer and endDrawer state restoration test',
      (WidgetTester tester) async {
    final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Drawer width can be customized by parameter',
      (WidgetTester tester) async {
  ...
  testWidgets('Material3 - Drawer default shape (ltr)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: true),
  ...
  testWidgets('Material3 - Drawer default shape (rtl)',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      MaterialApp(
        theme: ThemeData(useMaterial3: true),
  ...
  group('Material 2', () {
    ...
    testWidgets('Material2 - Drawer default shape',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(useMaterial3: false),
    ...
    testWidgets('Material2 - Drawer clip behavior',
        (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: ThemeData(useMaterial3: false),
