    ...
    if (!kIsWeb) {
      ...
      Color getPixel(int x, int y) {
        ...
        return Color.fromARGB(
            0xFF, bytes[offset], bytes[offset + 1], bytes[offset + 2]);
      }
      ...
      skip:
          kIsWeb); // TODO(ianh): https://github.com/flutter/flutter/issues/130612, https://github.com/flutter/flutter/issues/130609
          ...
          child: RepaintBoundary(
            child: Wrap(
              ...
              children: <Widget>[
                ...
                TestImage(DecorationImage.lerp(
                  DecorationImage(
                      image: wrgb, repeat: ImageRepeat.repeat, opacity: 0.2),
                  DecorationImage(
                      image: cmyk, repeat: ImageRepeat.repeat, opacity: 0.2),
                  0.25,
                )),
                TestImage(DecorationImage.lerp(
                  DecorationImage(
                ...
                TestImage(DecorationImage.lerp(
                  DecorationImage(
                      image: wrgb, scale: 0.5, repeat: ImageRepeat.repeatX),
                  DecorationImage(
                      image: cmyk, scale: 0.25, repeat: ImageRepeat.repeatY),
                  0.5,
                )),
                TestImage(DecorationImage.lerp(
                  DecorationImage(
...
class TestImage extends StatelessWidget {
  TestImage(
      this.image); // ignore: use_key_in_widget_constructors, prefer_const_constructors_in_immutables
