...
void main() {
  ...
  Offset textOffsetToPosition(WidgetTester tester, int offset) =>
      textOffsetToBottomLeftPosition(tester, offset) +
      const Offset(kIsWeb ? 1 : 0, -2);
  ...
  testWidgets('can get text selection color initially on desktop',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
    final TextEditingController controller = TextEditingController(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        const Size(
            200, 31), // 31 is the height of the default font + padding etc.
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.byType(CupertinoTextField)),
        const Size(200,
            31), // 31 is the height of the default font (17) + decoration (12).
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        tester.getSize(find.byType(CupertinoTextField)),
        const Size(200,
            65), // 65 is the height of the default font (17) * maxlines (3) + decoration height (12).
      );
    },
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Text placeholder = tester.widget(find.text('placeholder'));
      expect(placeholder.style!.color!.value,
          CupertinoColors.placeholderText.color.value);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        tester
            .getTopLeft(find.byIcon(CupertinoIcons.add))
            .dx, // 7px standard padding around input.
      );
  ...
  testWidgets('toolbar colors change with theme brightness, but nothing else',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        ...
        const TextSelection.collapsed(
            offset: 35, affinity: TextAffinity.upstream),
      );
  ...
  testWidgets('copy paste', (WidgetTester tester) async {
    ...
    await tester.longPress(find.text('field 2'),
        warnIfMissed: false); // can't actually hit placeholder
    await tester.pump();
    await tester.pump(const Duration(milliseconds: 200));
  ...
  testWidgets('tap moves cursor to the edge of the word it tapped on',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('slow double tap does not trigger double tap',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await tester.pumpAndSettle();
      expect(
          controller.selection, const TextSelection.collapsed(offset: index));
    },
    variant: TargetPlatformVariant.all(
        excluding: <TargetPlatform>{TargetPlatform.iOS, TargetPlatform.macOS}),
  );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      // on Mac.
      await tester
          .tapAt(textOffsetToPosition(tester, index) - const Offset(1.0, 0.0));
      await tester.pump(const Duration(milliseconds: 50));
      await tester.tapAt(textOffsetToPosition(tester, index));
      await tester.pumpAndSettle();
      expect(
  ...
  testWidgets('tap after a double tap select is not affected',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('double tapping a space selects the space on Mac',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: ' blah blah',
    );
  ...
  testWidgets('double clicking a space selects the space on Mac',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: ' blah blah',
    );
  ...
  testWidgets('long press tap cannot initiate a double tap',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
    ...
    final Offset secondTapPos =
        isTargetPlatformIOS ? ePos : ePos + const Offset(-1.0, 0.0);
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection(
            baseOffset: 0, extentOffset: 12, affinity: TextAffinity.upstream),
      );
      expectNoCupertinoToolbar();
      ...
      expect(
        controller.selection,
        const TextSelection(
            baseOffset: 0, extentOffset: 23, affinity: TextAffinity.upstream),
      );
      expectNoCupertinoToolbar();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      expect(
        controller.selection,
        const TextSelection.collapsed(
            offset: 6, affinity: TextAffinity.upstream),
      );
      expectNoCupertinoToolbar();
      ...
      expect(
        controller.selection,
        const TextSelection.collapsed(
            offset: 9, affinity: TextAffinity.upstream),
      );
      expectNoCupertinoToolbar();
  ...
  testWidgets('long press drag can edge scroll on non-Apple platforms',
    ...
    expect(
        lastCharEndpoint[0].point.dx, moreOrLessEquals(1094.73, epsilon: 0.25));
    ...
    expect(
        firstCharEndpoint[0].point.dx, moreOrLessEquals(-310.30, epsilon: 1));
  },
  ...
  testWidgets('long press drag can edge scroll on Apple platforms',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text:
          'Atwater Peel Sherbrooke Bonaventure Angrignon Peel Côte-des-Neiges',
    ...
    final RenderEditable renderEditable = tester.renderObject<RenderEditable>(
      find
          .byElementPredicate(
              (Element element) => element.renderObject is RenderEditable)
          .last,
    );
    ...
    expect(
      controller.selection,
      const TextSelection.collapsed(
          offset: 18, affinity: TextAffinity.upstream),
    );
    expect(find.byType(CupertinoButton), findsNothing);
    ...
    expect(
      controller.selection,
      const TextSelection.collapsed(
          offset: 54, affinity: TextAffinity.upstream),
    );
    // Keep moving out.
    await gesture.moveBy(const Offset(1, 0));
    await tester.pump();
    expect(
      controller.selection,
      const TextSelection.collapsed(
          offset: 61, affinity: TextAffinity.upstream),
    );
    await gesture.moveBy(const Offset(1, 0));
    await tester.pump();
    expect(
    ...
    expect(
        lastCharEndpoint[0].point.dx, moreOrLessEquals(784.73, epsilon: 0.25));
    ...
    expect(firstCharEndpoint.length, 1);
    // The first character is now offscreen to the left.
    expect(firstCharEndpoint[0].point.dx,
        moreOrLessEquals(-310.20, epsilon: 0.25));
  },
      variant: const TargetPlatformVariant(
          <TargetPlatform>{TargetPlatform.iOS, TargetPlatform.macOS}));

  testWidgets('long tap after a double tap select is not affected',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('double tap after a long tap is not affected',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('force press on unsupported devices falls back to tap',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'Atwater Peel Sherbrooke Bonaventure',
    );
  ...
  testWidgets('Continuous dragging does not cause flickering',
    ...
    const String testValue = 'abc def ghi';
    final TextEditingController controller =
        TextEditingController(text: testValue);
    addTearDown(controller.dispose);
  ...
  testWidgets('Tap does not show handles nor toolbar',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'abc def ghi',
    );
  ...
  testWidgets('Long press shows toolbar but not handles',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController(
      text: 'abc def ghi',
    );
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      final Offset textEndPos =
          textOffsetToPosition(tester, 11); // Position at the end of text.
  ...
  testWidgets('Focus test when the text field is disabled',
      (WidgetTester tester) async {
    final FocusNode focusNode = FocusNode();
    addTearDown(focusNode.dispose);
    await tester.pumpWidget(
      ...
      expect(
        tester
            .renderObject<RenderEditable>(
              find
                  .byElementPredicate((Element element) =>
  ...
  testWidgets('text field respects keyboardAppearance from theme',
      (WidgetTester tester) async {
    ...
    expect(
        ((setClient.arguments as List<dynamic>).last
            as Map<String, dynamic>)['keyboardAppearance'],
        'Brightness.dark');
  });

  testWidgets('text field can override keyboardAppearance from theme',
      (WidgetTester tester) async {
    final List<MethodCall> log = <MethodCall>[];
    tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(
        SystemChannels.textInput, (MethodCall methodCall) async {
  ...
  testWidgets('cursor can override color from theme',
      (WidgetTester tester) async {
    const CupertinoDynamicColor cursorColor =
  ...
  group('Text selection toolbar', () {
    testWidgets('Collapsed selection works', (WidgetTester tester) async {
        ...
        paints
          ..clipPath(
            pathMatcher: PathBoundsMatcher(
              topMatcher: moreOrLessEquals(bottomLeftSelectionPosition.dy + 8,
                  epsilon: 0.01),
      ...
      bottomLeftSelectionPosition = textOffsetToBottomLeftPosition(
          tester, state.renderEditable.selection!.baseOffset - 1);
      ...
      bottomLeftSelectionPosition = textOffsetToBottomLeftPosition(
          tester, state.renderEditable.selection!.baseOffset);
    ...
    testWidgets('selecting multiple words works', (WidgetTester tester) async {
      ...
      // it should point exactly to the caret.
      controller =
          TextEditingController(text: List<String>.filled(20, 'a').join('  '));
      addTearDown(controller.dispose);
      await tester.pumpWidget(
        CupertinoApp(
          debugShowCheckedModeBanner: false,
      ...
      expect(
        ...
        paints
          ..clipPath(
            pathMatcher: PathBoundsMatcher(
              bottomMatcher: moreOrLessEquals(
                  selectionPosition.dy - 8 - lineHeight,
                  epsilon: 0.01),
              topMatcher: moreOrLessEquals(
    ...
    testWidgets('selecting multiline works', (WidgetTester tester) async {
      ...
      controller = TextEditingController(
          text: List<String>.filled(20, 'a  a  ').join('\n'));
      addTearDown(controller.dispose);
      await tester.pumpWidget(
        CupertinoApp(
          debugShowCheckedModeBanner: false,
    ...
    testWidgets('Drag selection hides the selection menu',
        (WidgetTester tester) async {
      final TextEditingController controller = TextEditingController(
        text: 'blah1 blah2',
      );
  ...
  group('textAlignVertical position', () {
    group('simple case', () {
      testWidgets('align top (default)', (WidgetTester tester) async {
        ...
        expect(tester.getTopLeft(find.byType(CupertinoTextField)).dy,
            moreOrLessEquals(size.height, epsilon: .0001));
        expect(tester.getTopLeft(find.byType(EditableText)).dy,
    ...
    group('tall prefix', () {
      testWidgets('align center (default when prefix)',
          (WidgetTester tester) async {
        final FocusNode focusNode = FocusNode();
        addTearDown(focusNode.dispose);
        const Size size = Size(200.0, 200.0);
  ...
  testWidgets('Disabled Cupertino text field semantics',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
  ...
  testWidgets('Cupertino text field clear button semantics',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
  ...
  testWidgets('Cupertino text field clear semantic label',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      CupertinoApp(
        home: Center(
    ...
    expect(
      ...
      matchesSemantics(
          isButton: true, hasTapAction: true, label: 'Delete Text'),
    );
  });
                  ...
                  children: <Widget>[
                    CupertinoTextField(
                      ...
                      style: const TextStyle(
                          height: 4, color: ui.Color.fromARGB(100, 0, 0, 0)),
  ...
  testWidgets('textSelectionControls is passed to EditableText',
      (WidgetTester tester) async {
    final MockTextSelectionControls selectionControl =
  ...
  testWidgets('Disabled widget does not override background color',
      (WidgetTester tester) async {
  ...
  testWidgets('autofill info has placeholder text',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: CupertinoTextField(
  ...
  testWidgets('textDirection is passed to EditableText',
      (WidgetTester tester) async {
    await tester.pumpWidget(
      const CupertinoApp(
        home: Center(
  ...
  testWidgets('clipBehavior has expected defaults',
    ...
    final CupertinoTextField textField =
        tester.firstWidget(find.byType(CupertinoTextField));
  ...
  group('context menu', () {
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        expect(
            find.byType(CupertinoAdaptiveTextSelectionToolbar), findsNothing);
    ...
    group('magnifier builder', () {
      testWidgets('should build custom magnifier if given',
        ...
        expect(
            ...
            isA<Widget>().having((Widget widget) => widget.key, 'key',
                equals(customMagnifier.key)));
      });

      group('defaults', () {
        testWidgets('should build CupertinoMagnifier on iOS and Android',
            (WidgetTester tester) async {
          await tester.pumpWidget(const CupertinoApp(
            home: CupertinoTextField(),
          ));
          ...
          final BuildContext context =
              tester.firstElement(find.byType(CupertinoTextField));
          final EditableText editableText =
      ...
      testWidgets('should build nothing on all platforms but iOS and Android',
          (WidgetTester tester) async {
        await tester.pumpWidget(const CupertinoApp(
          home: CupertinoTextField(),
        ));
          ...
          home: CupertinoPageScaffold(
            child: Builder(
              builder: (BuildContext context) => CupertinoTextField(
                ...
                controller: controller,
                magnifierConfiguration: TextMagnifierConfiguration(
                    magnifierBuilder: (_, MagnifierController controller,
  ...
  group('TapRegion integration', () {
    ...
    testWidgets(
      ...
      variant: TargetPlatformVariant.all(),
      skip:
          kIsWeb, // [intended] The toolbar isn't rendered by Flutter on the web, it's rendered by the browser.
    );
  ...
  testWidgets('Can drag handles to change selection correctly in multiline',
    ...
    const String testValue = 'First line of text is\n'
        'Second line goes until\n'
        'Third line of stuff';

    const String cutValue = 'First line of text is\n'
        'Second until\n'
        'Third line of stuff';
    await tester.enterText(find.byType(CupertinoTextField), testValue);
    ...
    final Offset offsetFromEndPointToMiddlePoint =
        Offset(0.0, -renderEditable.preferredLineHeight / 2);
    ...
    newHandlePos = textOffsetToPosition(tester, testValue.indexOf('goes') + 4) +
        offsetFromEndPointToMiddlePoint;
    gesture = await tester.startGesture(handlePos, pointer: 7);
    await tester.pump();
    await gesture.moveTo(newHandlePos);
  ...
  testWidgets(
    ...
    final Rect rectWithPlaceholder =
        tester.getRect(find.byType(CupertinoTextField));
  ...
  testWidgets('Does not match the height of a multiline placeholder',
      (WidgetTester tester) async {
    final TextEditingController controller = TextEditingController();
    addTearDown(controller.dispose);
    await tester.pumpWidget(
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      await expectLater(
        find.byKey(const ValueKey<int>(1)),
        matchesGoldenFile(
            'text_field_floating_cursor.regular_and_floating_both.cupertino.0.png'),
      );
      ...
      await expectLater(
        find.byKey(const ValueKey<int>(1)),
        matchesGoldenFile(
            'text_field_floating_cursor.only_floating_cursor.cupertino.0.png'),
      );
      await gesture.up();
      EditableText.debugDeterministicCursor = false;
    },
