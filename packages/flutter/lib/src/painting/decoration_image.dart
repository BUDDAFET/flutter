...
class DecorationImage {
  ...
  static DecorationImage? lerp(
      DecorationImage? a, DecorationImage? b, double t) {
...
class _BlendedDecorationImage implements DecorationImage {
  const _BlendedDecorationImage(this.a, this.b, this.t)
...
class _BlendedDecorationImagePainter implements DecorationImagePainter {
  ...
  void paint(Canvas canvas, Rect rect, Path? clipPath,
    ...
    a?.paint(canvas, rect, clipPath, configuration,
        blend: blend * (1.0 - t), blendMode: blendMode);
