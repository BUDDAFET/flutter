  ...
  static void _handleDeviceUpdateMouseEvents(
    ...
    lastAnnotations
      ...
      if (annotation.validForMouseTracker &&
          !nextAnnotations.containsKey(annotation)) {
        annotation.onExit
            ?.call(baseExitEvent.transformed(lastAnnotations[annotation]));
      }
    });
    ...
    for (final MouseTrackerAnnotation annotation
      ...
      if (annotation.validForMouseTracker) {
        annotation.onEnter
            ?.call(baseEnterEvent.transformed(nextAnnotations[annotation]));
      }
    }
  }
}
