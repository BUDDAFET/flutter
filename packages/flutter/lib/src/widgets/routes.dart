...
class _ModalScopeStatus extends InheritedModel<_ModalRouteAspect> {
  ...
  @override
  bool updateShouldNotifyDependent(covariant _ModalScopeStatus oldWidget,
      Set<_ModalRouteAspect> dependencies) {
    return dependencies
        .any((_ModalRouteAspect dependency) => switch (dependency) {
...
abstract class ModalRoute<T> extends TransitionRoute<T>
  ...
  static ModalRoute<T>? _of<T extends Object?>(BuildContext context,
      [_ModalRouteAspect? aspect]) {
    return InheritedModel.inheritFrom<_ModalScopeStatus>(context,
            aspect: aspect)
        ?.route as ModalRoute<T>?;
  }
  ...
  bool get impliesAppBarDismissal =>
      hasActiveRouteBelow || _entriesImpliesAppBarDismissal > 0;
