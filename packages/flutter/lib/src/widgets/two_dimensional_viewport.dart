...
abstract class RenderTwoDimensionalViewport extends RenderBox
  ...
  @protected
  RenderBox? getChildFor(covariant ChildVicinity vicinity) =>
      _children[vicinity];
  ...
  RevealedOffset getOffsetToReveal(
    ...
    leadingScrollOffset += switch (axisDirection) {
      AxisDirection.up =>
        viewportDimension.height - paintOffset.dy - box.size.height,
      AxisDirection.left =>
        viewportDimension.width - paintOffset.dx - box.size.width,
