...
class _RenderLargeTitle extends RenderShiftedBox {
  ...
  static double _computeTitleScale(Size childSize, BoxConstraints constraints) {
    ...
    final double scale =
        1.0 + 0.03 * (constraints.maxHeight - maxHeight) / maxHeight;
  ...
  double? computeDryBaseline(
    ...
    return result * scale +
        alignment
            .alongOffset(constraints.biggest - scaledChildSize as Offset)
            .dy;
  }
  ...
  void performLayout() {
    ...
    childParentData.offset =
        alignment.alongOffset(size - (child.size * _scale) as Offset);
  }
