...
class UnderlineInputBorder extends InputBorder {
  ...
  void paint(
    ...
    if (borderRadius.bottomLeft != Radius.zero ||
      ...
      canvas.drawLine(rect.bottomLeft - alignInsideOffset,
          rect.bottomRight - alignInsideOffset, borderSide.toPaint());
    }
  }
...
class OutlineInputBorder extends InputBorder {
  ...
  void paint(
    ...
    if (gapStart == null || gapExtent <= 0.0 || gapPercentage == 0.0) {
      ...
      final Path path =
          _gapBorderPath(canvas, center, math.max(0.0, start), extent);
