...
class TextStyleItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle nameStyle = theme.textTheme.bodySmall!
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> styleItems = <Widget>[
      ...
      TextStyleItem(
          ...
          text: 'Medium 14/20 +0.1'),
      TextStyleItem(
          name: 'Body Large',
          style: textTheme.bodyLarge,
          text: 'Regular 16/24 +0.5'),
      TextStyleItem(
          name: 'Body Medium',
          style: textTheme.bodyMedium,
          text: 'Regular 14/20 +0.25'),
      TextStyleItem(
          name: 'Body Small',
          style: textTheme.bodySmall,
          text: 'Regular 12/16 +0.4'),
      TextStyleItem(
          name: 'Label Large',
      ...
      TextStyleItem(
          ...
          text: 'Medium 12/16 +0.5'),
      TextStyleItem(
          name: 'Label Small',
          style: textTheme.labelSmall,
          text: 'Medium 11/16 +0.5'),
    ];
